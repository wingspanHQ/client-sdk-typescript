...
/** @internal */
export const Remail1099Request$inboundSchema: z.ZodType<Remail1099Request, z.ZodTypeDef, unknown> =
    z.object({
        address: Sevenb49dbbd81f36ab6d7b4f07c5e2e53f40e36eb7b83d1488f379e993b830eec56$inboundSchema,
...
export const Remail1099Request$outboundSchema: z.ZodType<
    ...
    Remail1099Request
> = z.object({
    address: Sevenb49dbbd81f36ab6d7b4f07c5e2e53f40e36eb7b83d1488f379e993b830eec56$outboundSchema,
    documentIndex: z.nullable(z.number()).optional(),
    memberId: z.string(),
    year: z.number(),
});
