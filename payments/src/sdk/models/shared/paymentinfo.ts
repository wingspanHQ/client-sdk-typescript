...
/** @internal */
export const MeansType$inboundSchema: z.ZodNativeEnum<typeof MeansType> = z.nativeEnum(MeansType);

/** @internal */
export const MeansType$outboundSchema: z.ZodNativeEnum<typeof MeansType> = MeansType$inboundSchema;
...
/** @internal */
export const PaymentInfo$inboundSchema: z.ZodType<PaymentInfo, z.ZodTypeDef, unknown> = z.object({
