...
export namespace GetCollaboratorGroupConfigurationRequest$ {
    ...
    export const inboundSchema = GetCollaboratorGroupConfigurationRequest$inboundSchema;
    /** @deprecated use `GetCollaboratorGroupConfigurationRequest$outboundSchema` instead. */
    export const outboundSchema = GetCollaboratorGroupConfigurationRequest$outboundSchema;
...
/** @internal */
export const GetCollaboratorGroupConfigurationResponse$outboundSchema: z.ZodType<
...
export namespace GetCollaboratorGroupConfigurationResponse$ {
    ...
    export const inboundSchema = GetCollaboratorGroupConfigurationResponse$inboundSchema;
    /** @deprecated use `GetCollaboratorGroupConfigurationResponse$outboundSchema` instead. */
    export const outboundSchema = GetCollaboratorGroupConfigurationResponse$outboundSchema;
