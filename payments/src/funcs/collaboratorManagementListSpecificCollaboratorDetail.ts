 ...
 */
export async function collaboratorManagementListSpecificCollaboratorDetail(
    client$: PaymentsCore,
...
> {
    ...
    const parsed$ = schemas$.safeParse(
        input$,
        (value$) => operations.ListSpecificCollaboratorDetailsRequest$outboundSchema.parse(value$),
