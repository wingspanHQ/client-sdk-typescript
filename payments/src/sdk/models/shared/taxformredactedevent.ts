...
/** @internal */
export const PreviousData$inboundSchema: z.ZodType<
  PreviousData,
  z.ZodTypeDef,
  unknown
> = z.object({});
...
/** @internal */
export const RecipientSyncToggled$inboundSchema: z.ZodNativeEnum<
  typeof RecipientSyncToggled
> = z.nativeEnum(RecipientSyncToggled);

/** @internal */
export const RecipientSyncToggled$outboundSchema: z.ZodNativeEnum<
  typeof RecipientSyncToggled
...
/** @internal */
export const TriggeredBy$inboundSchema: z.ZodNativeEnum<typeof TriggeredBy> = z
  .nativeEnum(TriggeredBy);
...
export const TaxFormRedactedEvent$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  data: z.nullable(z.lazy(() => TaxFormRedactedEventData$inboundSchema))
    .optional(),
  ...
  recipientSyncToggled: z.nullable(RecipientSyncToggled$inboundSchema)
    .optional(),
  timestamp: z.string(),
...
export const TaxFormRedactedEvent$outboundSchema: z.ZodType<
  ...
  TaxFormRedactedEvent
> = z.object({
  data: z.nullable(z.lazy(() => TaxFormRedactedEventData$outboundSchema))
    .optional(),
  eventActor: z.nullable(RedactedMember$outboundSchema).optional(),
  eventActorId: z.nullable(z.string()).optional(),
  eventType: EventType$outboundSchema,
  previousData: z.nullable(z.lazy(() => PreviousData$outboundSchema))
    .optional(),
  recipientSyncToggled: z.nullable(RecipientSyncToggled$outboundSchema)
    .optional(),
  timestamp: z.string(),
