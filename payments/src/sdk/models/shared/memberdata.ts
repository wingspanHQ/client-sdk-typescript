...
/** @internal */
export const AutoPayRequirement$inboundSchema: z.ZodNativeEnum<typeof AutoPayRequirement> =
    z.nativeEnum(AutoPayRequirement);

/** @internal */
export const AutoPayRequirement$outboundSchema: z.ZodNativeEnum<typeof AutoPayRequirement> =
...
/** @internal */
export const ShareTaxDocument$inboundSchema: z.ZodNativeEnum<typeof ShareTaxDocument> =
    z.nativeEnum(ShareTaxDocument);

/** @internal */
export const ShareTaxDocument$outboundSchema: z.ZodNativeEnum<typeof ShareTaxDocument> =
...
/** @internal */
export const MemberData$inboundSchema: z.ZodType<MemberData, z.ZodTypeDef, unknown> = z.object({
...
/** @internal */
export const MemberData$outboundSchema: z.ZodType<MemberData$Outbound, z.ZodTypeDef, MemberData> =
    z.object({
