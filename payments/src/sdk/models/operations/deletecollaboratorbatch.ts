...
export namespace DeleteCollaboratorBatchRequest$ {
    ...
    export const inboundSchema: z.ZodType<DeleteCollaboratorBatchRequest, z.ZodTypeDef, Inbound> = z
        .object({
            batchId: z.string(),
        })
        .transform((v) => {
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, DeleteCollaboratorBatchRequest> =
        z
            .object({
                batchId: z.string(),
            })
...
export namespace DeleteCollaboratorBatchResponse$ {
    ...
    export const inboundSchema: z.ZodType<DeleteCollaboratorBatchResponse, z.ZodTypeDef, Inbound> =
        z
            .object({
