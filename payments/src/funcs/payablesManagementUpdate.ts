 ...
 */
export async function payablesManagementUpdate(
  client: PaymentsCore,
...
> {
  ...
  const body = encodeJSON("body", payload.PayableUpdateRequest, {
    explode: true,
  });
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, operations.UpdatePayableResponse$inboundSchema, {
      key: "PayableSchema",
    }),
