...
export class PostPaymentsInvoiceInvoiceIdGenerateRequest extends SpeakeasyBase {
    /**
...
export class PostPaymentsInvoiceInvoiceIdGenerateResponse extends SpeakeasyBase {
    /**
