...
export namespace DisassociateCollaboratorWithGroupRequest$ {
    ...
    export const inboundSchema = DisassociateCollaboratorWithGroupRequest$inboundSchema;
    /** @deprecated use `DisassociateCollaboratorWithGroupRequest$outboundSchema` instead. */
    export const outboundSchema = DisassociateCollaboratorWithGroupRequest$outboundSchema;
...
/** @internal */
export const DisassociateCollaboratorWithGroupResponse$outboundSchema: z.ZodType<
...
export namespace DisassociateCollaboratorWithGroupResponse$ {
    ...
    export const inboundSchema = DisassociateCollaboratorWithGroupResponse$inboundSchema;
    /** @deprecated use `DisassociateCollaboratorWithGroupResponse$outboundSchema` instead. */
    export const outboundSchema = DisassociateCollaboratorWithGroupResponse$outboundSchema;
