...
export class PatchPaymentsBulkClientBatchBatchIdItemBatchItemIdRequest extends SpeakeasyBase {
...
export class PatchPaymentsBulkClientBatchBatchIdItemBatchItemIdResponse extends SpeakeasyBase {
    /**
