...
export const GetPayableBatchItemResponse$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  BulkPayableImportSummary: shared.BulkPayableImportSummary$inboundSchema
    .optional(),
...
export type GetPayableBatchItemResponse$Outbound = {
  BulkPayableImportSummary?:
    | shared.BulkPayableImportSummary$Outbound
    | undefined;
  ContentType: string;
  StatusCode: number;
  RawResponse: never;
...
export const GetPayableBatchItemResponse$outboundSchema: z.ZodType<
  ...
  GetPayableBatchItemResponse
> = z.object({
  bulkPayableImportSummary: shared.BulkPayableImportSummary$outboundSchema
    .optional(),
  contentType: z.string(),
  statusCode: z.number().int(),
