...
/** @internal */
export const InvoiceRefundDestinationDestinationType$inboundSchema: z.ZodNativeEnum<
    typeof InvoiceRefundDestinationDestinationType
> = z.nativeEnum(InvoiceRefundDestinationDestinationType);

/** @internal */
export const InvoiceRefundDestinationDestinationType$outboundSchema: z.ZodNativeEnum<
    typeof InvoiceRefundDestinationDestinationType
...
export namespace InvoiceRefundDestinationDestinationType$ {
    ...
    export const inboundSchema = InvoiceRefundDestinationDestinationType$inboundSchema;
    /** @deprecated use `InvoiceRefundDestinationDestinationType$outboundSchema` instead. */
    export const outboundSchema = InvoiceRefundDestinationDestinationType$outboundSchema;
}
