...
export type InvoiceUpdateRequestStatus = ClosedEnum<
...
/** @internal */
export const InvoiceUpdateRequestAcceptedPaymentMethods$inboundSchema:
  z.ZodNativeEnum<typeof InvoiceUpdateRequestAcceptedPaymentMethods> = z
    .nativeEnum(InvoiceUpdateRequestAcceptedPaymentMethods);

/** @internal */
export const InvoiceUpdateRequestAcceptedPaymentMethods$outboundSchema:
  z.ZodNativeEnum<typeof InvoiceUpdateRequestAcceptedPaymentMethods> =
...
export namespace InvoiceUpdateRequestAcceptedPaymentMethods$ {
  ...
  export const outboundSchema =
    InvoiceUpdateRequestAcceptedPaymentMethods$outboundSchema;
}
...
> = z.object({
  acceptedPaymentMethods: z.nullable(
    z.array(InvoiceUpdateRequestAcceptedPaymentMethods$inboundSchema),
  ).optional(),
  attachments: z.nullable(
    ThirtySixb041d426951ffff76360faf03ef8ae938bed9739e6ad9f51acb982782296a2$inboundSchema,
  ).optional(),
  chargedFees: z.nullable(Fees$inboundSchema).optional(),
  client: z.nullable(z.lazy(() => InvoiceUpdateRequestClient$inboundSchema))
    .optional(),
  ...
  lineItems: z.nullable(z.array(InvoiceLineItemsCreateRequest$inboundSchema))
    .optional(),
  member: z.nullable(z.lazy(() => InvoiceUpdateRequestMember$inboundSchema))
    .optional(),
...
> = z.object({
  acceptedPaymentMethods: z.nullable(
    z.array(InvoiceUpdateRequestAcceptedPaymentMethods$outboundSchema),
  ).optional(),
  attachments: z.nullable(
    ThirtySixb041d426951ffff76360faf03ef8ae938bed9739e6ad9f51acb982782296a2$outboundSchema,
  ).optional(),
  chargedFees: z.nullable(Fees$outboundSchema).optional(),
  client: z.nullable(z.lazy(() => InvoiceUpdateRequestClient$outboundSchema))
    .optional(),
  collaborators: z.nullable(
  ...
  lineItems: z.nullable(z.array(InvoiceLineItemsCreateRequest$outboundSchema))
    .optional(),
  member: z.nullable(z.lazy(() => InvoiceUpdateRequestMember$outboundSchema))
    .optional(),
  memberClientId: z.nullable(z.string()).optional(),
