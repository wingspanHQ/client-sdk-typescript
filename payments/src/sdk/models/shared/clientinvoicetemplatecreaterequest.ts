...
/** @internal */
export const ClientInvoiceTemplateCreateRequestStatus$inboundSchema: z.ZodNativeEnum<
    typeof ClientInvoiceTemplateCreateRequestStatus
> = z.nativeEnum(ClientInvoiceTemplateCreateRequestStatus);

/** @internal */
export const ClientInvoiceTemplateCreateRequestStatus$outboundSchema: z.ZodNativeEnum<
    typeof ClientInvoiceTemplateCreateRequestStatus
...
export namespace ClientInvoiceTemplateCreateRequestStatus$ {
    ...
    export const inboundSchema = ClientInvoiceTemplateCreateRequestStatus$inboundSchema;
    /** @deprecated use `ClientInvoiceTemplateCreateRequestStatus$outboundSchema` instead. */
    export const outboundSchema = ClientInvoiceTemplateCreateRequestStatus$outboundSchema;
}
...
export namespace ClientInvoiceTemplateCreateRequest$ {
    ...
    export const outboundSchema = ClientInvoiceTemplateCreateRequest$outboundSchema;
