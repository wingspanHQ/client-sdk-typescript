 ...
 */
export async function bulkOperationsUpdatePayable(
  client$: PaymentsCore,
...
> {
  ...
  const parsed$ = schemas$.safeParse(
    input$,
    (value$) =>
      operations.UpdatePayableBatchRequest$outboundSchema.parse(value$),
  ...
  const body$ = encodeJSON$("body", payload$.BulkPayableBatchUpdate, {
    explode: true,
  });
  ...
  const path$ = pathToFunc("/payments/bulk/payable/batch/{batchId}")(
    pathParams$,
  );
