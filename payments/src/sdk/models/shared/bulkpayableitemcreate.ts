...
export namespace BulkPayableItemCreatePayableStatus$ {
    ...
    export const outboundSchema = BulkPayableItemCreatePayableStatus$outboundSchema;
}

/** @internal */
export const BulkPayableItemCreateWorkflowSubStatus$inboundSchema: z.ZodNativeEnum<
    typeof BulkPayableItemCreateWorkflowSubStatus
> = z.nativeEnum(BulkPayableItemCreateWorkflowSubStatus);

/** @internal */
export const BulkPayableItemCreateWorkflowSubStatus$outboundSchema: z.ZodNativeEnum<
    typeof BulkPayableItemCreateWorkflowSubStatus
...
export namespace BulkPayableItemCreateWorkflowSubStatus$ {
    ...
    export const inboundSchema = BulkPayableItemCreateWorkflowSubStatus$inboundSchema;
    /** @deprecated use `BulkPayableItemCreateWorkflowSubStatus$outboundSchema` instead. */
    export const outboundSchema = BulkPayableItemCreateWorkflowSubStatus$outboundSchema;
}
...
> = z.object({
    ...
    workflowSubStatus: z.nullable(BulkPayableItemCreateWorkflowSubStatus$inboundSchema).optional(),
});
...
> = z.object({
    ...
    reimbursableExpense: z.nullable(z.boolean()).optional(),
    workflowSubStatus: z.nullable(BulkPayableItemCreateWorkflowSubStatus$outboundSchema).optional(),
});
