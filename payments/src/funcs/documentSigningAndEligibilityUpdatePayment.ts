 ...
 */
export async function documentSigningAndEligibilityUpdatePayment(
  client: PaymentsCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.UpdatePaymentEligibilityRequirementRequest$outboundSchema
        .parse(value),
  ...
  >(
    M.json(
      200,
      operations.UpdatePaymentEligibilityRequirementResponse$inboundSchema,
