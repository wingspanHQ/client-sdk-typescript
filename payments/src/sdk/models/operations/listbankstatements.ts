...
export namespace ListBankStatementsResponse$ {
    ...
    export const inboundSchema: z.ZodType<ListBankStatementsResponse, z.ZodTypeDef, Inbound> = z
        .object({
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, ListBankStatementsResponse> = z
        .object({
            contentType: z.string(),
            statusCode: z.number().int(),
