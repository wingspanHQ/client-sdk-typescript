...
export namespace CreatePayableResponse$ {
    ...
    export const inboundSchema: z.ZodType<CreatePayableResponse, z.ZodTypeDef, Inbound> = z
        .object({
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, CreatePayableResponse> = z
        .object({
            contentType: z.string(),
