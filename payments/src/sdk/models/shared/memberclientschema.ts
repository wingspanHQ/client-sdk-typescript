...
export type MemberClientSchemaStatus = ClosedEnum<typeof MemberClientSchemaStatus>;
...
/** @internal */
export const MemberClientSchemaClientUserAccountType$inboundSchema: z.ZodNativeEnum<
    typeof MemberClientSchemaClientUserAccountType
> = z.nativeEnum(MemberClientSchemaClientUserAccountType);

/** @internal */
export const MemberClientSchemaClientUserAccountType$outboundSchema: z.ZodNativeEnum<
    typeof MemberClientSchemaClientUserAccountType
...
export namespace MemberClientSchemaClientUserAccountType$ {
    ...
    export const inboundSchema = MemberClientSchemaClientUserAccountType$inboundSchema;
    /** @deprecated use `MemberClientSchemaClientUserAccountType$outboundSchema` instead. */
    export const outboundSchema = MemberClientSchemaClientUserAccountType$outboundSchema;
}
