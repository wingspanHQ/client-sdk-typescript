...
/** @internal */
export const PayableStatus$inboundSchema: z.ZodNativeEnum<
  typeof PayableStatus
> = z.nativeEnum(PayableStatus);

/** @internal */
export const PayableStatus$outboundSchema: z.ZodNativeEnum<
  typeof PayableStatus
...
/** @internal */
export const BulkPayableItemStatus$inboundSchema: z.ZodNativeEnum<
  typeof BulkPayableItemStatus
> = z.nativeEnum(BulkPayableItemStatus);

/** @internal */
export const BulkPayableItemStatus$outboundSchema: z.ZodNativeEnum<
  typeof BulkPayableItemStatus
...
/** @internal */
export const WorkflowSubStatus$inboundSchema: z.ZodNativeEnum<
  typeof WorkflowSubStatus
> = z.nativeEnum(WorkflowSubStatus);

/** @internal */
export const WorkflowSubStatus$outboundSchema: z.ZodNativeEnum<
  typeof WorkflowSubStatus
...
/** @internal */
export const BulkPayableItem$inboundSchema: z.ZodType<
  BulkPayableItem,
  z.ZodTypeDef,
  unknown
> = z.object({
...
export function bulkPayableItemToJSON(
  bulkPayableItem: BulkPayableItem,
): string {
  return JSON.stringify(BulkPayableItem$outboundSchema.parse(bulkPayableItem));
}

export function bulkPayableItemFromJSON(
  jsonString: string,
): SafeParseResult<BulkPayableItem, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => BulkPayableItem$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'BulkPayableItem' from JSON`,
  );
}
