 ...
 */
export async function customFieldManagementDelete(
  client$: PaymentsCore,
...
> {
  ...
  const parsed$ = schemas$.safeParse(
    input$,
    (value$) =>
      operations.DeleteCustomFieldRequest$outboundSchema.parse(value$),
  ...
  const [result$] = await m$.match<
    ...
    | ConnectionError
  >(
    m$.json(200, operations.DeleteCustomFieldResponse$inboundSchema, {
      key: "CustomField",
    }),
