 ...
 */
export async function bulkOperationsUpdateCollaborator(
  client$: PaymentsCore,
...
> {
  ...
  const parsed$ = schemas$.safeParse(
    input$,
    (value$) =>
      operations.UpdateCollaboratorBatchRequest$outboundSchema.parse(value$),
  ...
  const path$ = pathToFunc("/payments/bulk/collaborator/batch/{batchId}")(
    pathParams$,
  );
