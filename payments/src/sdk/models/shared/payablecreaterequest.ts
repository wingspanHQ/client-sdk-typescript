...
export type PayableCreateRequestCurrency = ClosedEnum<typeof PayableCreateRequestCurrency>;
...
export type PayableCreateRequestStatus = ClosedEnum<typeof PayableCreateRequestStatus>;
...
/** @internal */
export const PayableCreateRequestAcceptedPaymentMethods$inboundSchema: z.ZodNativeEnum<
    typeof PayableCreateRequestAcceptedPaymentMethods
> = z.nativeEnum(PayableCreateRequestAcceptedPaymentMethods);

/** @internal */
export const PayableCreateRequestAcceptedPaymentMethods$outboundSchema: z.ZodNativeEnum<
    typeof PayableCreateRequestAcceptedPaymentMethods
...
export namespace PayableCreateRequestAcceptedPaymentMethods$ {
    ...
    export const inboundSchema = PayableCreateRequestAcceptedPaymentMethods$inboundSchema;
    /** @deprecated use `PayableCreateRequestAcceptedPaymentMethods$outboundSchema` instead. */
    export const outboundSchema = PayableCreateRequestAcceptedPaymentMethods$outboundSchema;
}
...
> = z.object({
    acceptedPaymentMethods: z
        .nullable(z.array(PayableCreateRequestAcceptedPaymentMethods$inboundSchema))
        .optional(),
    attachments: z
        .nullable(
            ThirtySixb041d426951ffff76360faf03ef8ae938bed9739e6ad9f51acb982782296a2$inboundSchema
...
> = z.object({
    acceptedPaymentMethods: z
        .nullable(z.array(PayableCreateRequestAcceptedPaymentMethods$outboundSchema))
        .optional(),
    attachments: z
        .nullable(
            ThirtySixb041d426951ffff76360faf03ef8ae938bed9739e6ad9f51acb982782296a2$outboundSchema
