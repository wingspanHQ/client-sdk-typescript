...
export namespace UpdateSpecificInvoiceBatchRequest$ {
    ...
    export const outboundSchema = UpdateSpecificInvoiceBatchRequest$outboundSchema;
...
export namespace UpdateSpecificInvoiceBatchResponse$ {
    ...
    export const outboundSchema = UpdateSpecificInvoiceBatchResponse$outboundSchema;
