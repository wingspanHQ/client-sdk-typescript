...
/** @internal */
export const CardDetailsStatus$inboundSchema: z.ZodNativeEnum<typeof CardDetailsStatus> =
    z.nativeEnum(CardDetailsStatus);

/** @internal */
export const CardDetailsStatus$outboundSchema: z.ZodNativeEnum<typeof CardDetailsStatus> =
...
/** @internal */
export const CardDetailsType$inboundSchema: z.ZodNativeEnum<typeof CardDetailsType> =
    z.nativeEnum(CardDetailsType);

/** @internal */
export const CardDetailsType$outboundSchema: z.ZodNativeEnum<typeof CardDetailsType> =
...
/** @internal */
export const CardDetails$inboundSchema: z.ZodType<CardDetails, z.ZodTypeDef, unknown> = z.object({
