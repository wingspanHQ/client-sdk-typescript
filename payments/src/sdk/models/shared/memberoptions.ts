...
export type MemberOptionsWorkflowStatus = ClosedEnum<typeof MemberOptionsWorkflowStatus>;

export const MemberOptionsWorkflowSubStatus = {
    Submitted: "Submitted",
} as const;
export type MemberOptionsWorkflowSubStatus = ClosedEnum<typeof MemberOptionsWorkflowSubStatus>;
...
/** @internal */
export const PayoutPreferences$inboundSchema: z.ZodNativeEnum<typeof PayoutPreferences> =
    z.nativeEnum(PayoutPreferences);

/** @internal */
export const PayoutPreferences$outboundSchema: z.ZodNativeEnum<typeof PayoutPreferences> =
...
/** @internal */
export const MemberOptions$inboundSchema: z.ZodType<MemberOptions, z.ZodTypeDef, unknown> =
    z.object({
        comment: z.nullable(z.string()).optional(),
        payoutPreferences: z.nullable(PayoutPreferences$inboundSchema).optional(),
        workflowStatus: z.nullable(MemberOptionsWorkflowStatus$inboundSchema).optional(),
        workflowSubStatus: z.nullable(MemberOptionsWorkflowSubStatus$inboundSchema).optional(),
    });
...
> = z.object({
    ...
    workflowStatus: z.nullable(MemberOptionsWorkflowStatus$outboundSchema).optional(),
    workflowSubStatus: z.nullable(MemberOptionsWorkflowSubStatus$outboundSchema).optional(),
});
