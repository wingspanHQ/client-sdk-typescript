...
/** @internal */
export const InternationalPayroll$inboundSchema: z.ZodNativeEnum<typeof InternationalPayroll> =
    z.nativeEnum(InternationalPayroll);

/** @internal */
export const InternationalPayroll$outboundSchema: z.ZodNativeEnum<typeof InternationalPayroll> =
...
/** @internal */
export const PayrollSettingsStatus$inboundSchema: z.ZodNativeEnum<typeof PayrollSettingsStatus> =
    z.nativeEnum(PayrollSettingsStatus);

/** @internal */
export const PayrollSettingsStatus$outboundSchema: z.ZodNativeEnum<typeof PayrollSettingsStatus> =
...
/** @internal */
export const Workflow$inboundSchema: z.ZodNativeEnum<typeof Workflow> = z.nativeEnum(Workflow);

/** @internal */
export const Workflow$outboundSchema: z.ZodNativeEnum<typeof Workflow> = Workflow$inboundSchema;
...
/** @internal */
export const PayrollSettings$inboundSchema: z.ZodType<PayrollSettings, z.ZodTypeDef, unknown> =
    z.object({
        ...
        internationalPayroll: z.nullable(InternationalPayroll$inboundSchema).optional(),
...
> = z.object({
    ...
    internationalPayroll: z.nullable(InternationalPayroll$outboundSchema).optional(),
    issue1099s: z.nullable(z.boolean()).optional(),
    processDaysBeforeDue: z.nullable(z.number()).optional(),
    runsPayroll: z.nullable(z.boolean()).optional(),
