...
export namespace ListPayableBatchesResponse$ {
    export type Inbound = {
        ...
        StatusCode: number;
        RawResponse: Response;
        classes?: Array<shared.BulkPayableBatch$.Inbound> | undefined;
    };

    export const inboundSchema: z.ZodType<ListPayableBatchesResponse, z.ZodTypeDef, Inbound> = z
        .object({
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, ListPayableBatchesResponse> = z
        .object({
            contentType: z.string(),
            statusCode: z.number().int(),
