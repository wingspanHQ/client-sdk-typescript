...
export type UpdateInvoiceTemplateRequest = {
  invoiceTemplateUpdateRequest?:
    | shared.InvoiceTemplateUpdateRequest
    | undefined;
  /**
   * Unique identifier
   */
...
export const UpdateInvoiceTemplateRequest$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  InvoiceTemplateUpdateRequest: shared
    .InvoiceTemplateUpdateRequest$inboundSchema.optional(),
  id: z.string(),
}).transform((v) => {
  return remap$(v, {
...
export type UpdateInvoiceTemplateRequest$Outbound = {
  InvoiceTemplateUpdateRequest?:
    | shared.InvoiceTemplateUpdateRequest$Outbound
    | undefined;
  id: string;
};
...
> = z.object({
  invoiceTemplateUpdateRequest: shared
    .InvoiceTemplateUpdateRequest$outboundSchema.optional(),
  id: z.string(),
}).transform((v) => {
  return remap$(v, {
    invoiceTemplateUpdateRequest: "InvoiceTemplateUpdateRequest",
