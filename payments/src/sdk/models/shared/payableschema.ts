...
/** @internal */
export const PayableSchemaAcceptedPaymentMethods$outboundSchema: z.ZodNativeEnum<
    typeof PayableSchemaAcceptedPaymentMethods
...
export namespace PayableSchemaAcceptedPaymentMethods$ {
    ...
    export const inboundSchema = PayableSchemaAcceptedPaymentMethods$inboundSchema;
    /** @deprecated use `PayableSchemaAcceptedPaymentMethods$outboundSchema` instead. */
    export const outboundSchema = PayableSchemaAcceptedPaymentMethods$outboundSchema;
}

/** @internal */
export const PayableSchemaCurrency$inboundSchema: z.ZodNativeEnum<typeof PayableSchemaCurrency> =
    z.nativeEnum(PayableSchemaCurrency);

/** @internal */
export const PayableSchemaCurrency$outboundSchema: z.ZodNativeEnum<typeof PayableSchemaCurrency> =
...
/** @internal */
export const PayableSchemaStatus$inboundSchema: z.ZodNativeEnum<typeof PayableSchemaStatus> =
    z.nativeEnum(PayableSchemaStatus);

/** @internal */
export const PayableSchemaStatus$outboundSchema: z.ZodNativeEnum<typeof PayableSchemaStatus> =
...
/** @internal */
export const PayableSchema$inboundSchema: z.ZodType<PayableSchema, z.ZodTypeDef, unknown> =
    z.object({
        acceptedPaymentMethods: z
            .nullable(z.array(PayableSchemaAcceptedPaymentMethods$inboundSchema))
            .optional(),
...
> = z.object({
    acceptedPaymentMethods: z
        .nullable(z.array(PayableSchemaAcceptedPaymentMethods$outboundSchema))
        .optional(),
    accountId: z.nullable(z.string()).optional(),
    amount: z.number(),
    ...
    integration: Sixb94b58d661f3eabc1444a7a43ac4b99580f0d050123b7bf38184e2f0d7bd66e$outboundSchema,
