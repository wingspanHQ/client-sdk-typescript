...
/** @internal */
export const ProcessingStrategy$inboundSchema: z.ZodNativeEnum<
  typeof ProcessingStrategy
> = z.nativeEnum(ProcessingStrategy);

/** @internal */
export const ProcessingStrategy$outboundSchema: z.ZodNativeEnum<
  typeof ProcessingStrategy
...
/** @internal */
export const BulkInvoiceBatchStatus$inboundSchema: z.ZodNativeEnum<
  typeof BulkInvoiceBatchStatus
> = z.nativeEnum(BulkInvoiceBatchStatus);

/** @internal */
export const BulkInvoiceBatchStatus$outboundSchema: z.ZodNativeEnum<
  typeof BulkInvoiceBatchStatus
...
/** @internal */
export const BulkInvoiceBatch$inboundSchema: z.ZodType<
  BulkInvoiceBatch,
  z.ZodTypeDef,
  unknown
> = z.object({
