...
export namespace GetEventAssociatedCollaboratorRequest$ {
    ...
    export const inboundSchema = GetEventAssociatedCollaboratorRequest$inboundSchema;
    /** @deprecated use `GetEventAssociatedCollaboratorRequest$outboundSchema` instead. */
    export const outboundSchema = GetEventAssociatedCollaboratorRequest$outboundSchema;
...
export namespace GetEventAssociatedCollaboratorResponse$ {
    ...
    export const inboundSchema = GetEventAssociatedCollaboratorResponse$inboundSchema;
    /** @deprecated use `GetEventAssociatedCollaboratorResponse$outboundSchema` instead. */
    export const outboundSchema = GetEventAssociatedCollaboratorResponse$outboundSchema;
