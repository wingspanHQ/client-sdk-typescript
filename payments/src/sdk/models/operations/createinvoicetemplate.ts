...
export namespace CreateInvoiceTemplateResponse$ {
    ...
    export const inboundSchema: z.ZodType<CreateInvoiceTemplateResponse, z.ZodTypeDef, Inbound> = z
        .object({
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, CreateInvoiceTemplateResponse> =
        z
            .object({
                contentType: z.string(),
