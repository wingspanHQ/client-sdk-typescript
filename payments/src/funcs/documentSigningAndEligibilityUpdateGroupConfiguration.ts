 ...
 */
export async function documentSigningAndEligibilityUpdateGroupConfiguration(
  client: PaymentsCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.UpdateCollaboratorGroupConfigurationRequest$outboundSchema
        .parse(value),
  ...
  >(
    M.json(
      200,
      operations.UpdateCollaboratorGroupConfigurationResponse$inboundSchema,
