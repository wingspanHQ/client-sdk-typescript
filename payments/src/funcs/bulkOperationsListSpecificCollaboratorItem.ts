 ...
 */
export async function bulkOperationsListSpecificCollaboratorItem(
  client: PaymentsCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ListSpecificCollaboratorBatchItemsRequest$outboundSchema.parse(
        value,
      ),
  ...
  >(
    M.json(
      200,
      operations.ListSpecificCollaboratorBatchItemsResponse$inboundSchema,
      { key: "classes" },
    ),
