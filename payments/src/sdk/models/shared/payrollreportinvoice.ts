...
export type PayrollReportInvoiceStatus = ClosedEnum<typeof PayrollReportInvoiceStatus>;
...
> = z.object({
    ...
    dueDate: z.string(),
    eventActors: z
        .nullable(Fcbf27c731b13d8b05460d28c0f87d3355c006cefcc1528c739ebdcf7cb45c8c$inboundSchema)
        .optional(),
    invoiceId: z.string(),
...
> = z.object({
    ...
    dueDate: z.string(),
    eventActors: z
        .nullable(Fcbf27c731b13d8b05460d28c0f87d3355c006cefcc1528c739ebdcf7cb45c8c$outboundSchema)
        .optional(),
    invoiceId: z.string(),
    invoiceNumber: z.string(),
    invoicePdf: z.string(),
