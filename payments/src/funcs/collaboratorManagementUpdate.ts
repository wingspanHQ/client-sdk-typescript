 ...
 */
export async function collaboratorManagementUpdate(
  client$: PaymentsCore,
...
> {
  ...
  const parsed$ = schemas$.safeParse(
    input$,
    (value$) =>
      operations.UpdateCollaboratorRequest$outboundSchema.parse(value$),
  ...
  const body$ = encodeJSON$("body", payload$.CollaboratorUpdateRequest, {
    explode: true,
  });
