...
export type InvoiceCreateRequestCurrency = ClosedEnum<typeof InvoiceCreateRequestCurrency>;
...
export type InvoiceCreateRequestStatus = ClosedEnum<typeof InvoiceCreateRequestStatus>;
...
/** @internal */
export const InvoiceCreateRequestAcceptedPaymentMethods$inboundSchema: z.ZodNativeEnum<
    typeof InvoiceCreateRequestAcceptedPaymentMethods
> = z.nativeEnum(InvoiceCreateRequestAcceptedPaymentMethods);

/** @internal */
export const InvoiceCreateRequestAcceptedPaymentMethods$outboundSchema: z.ZodNativeEnum<
    typeof InvoiceCreateRequestAcceptedPaymentMethods
...
export namespace InvoiceCreateRequestAcceptedPaymentMethods$ {
    ...
    export const inboundSchema = InvoiceCreateRequestAcceptedPaymentMethods$inboundSchema;
    /** @deprecated use `InvoiceCreateRequestAcceptedPaymentMethods$outboundSchema` instead. */
    export const outboundSchema = InvoiceCreateRequestAcceptedPaymentMethods$outboundSchema;
}
...
/** @internal */
export const Member$inboundSchema: z.ZodType<Member, z.ZodTypeDef, unknown> = z.object({});

/** @internal */
export type Member$Outbound = {};

/** @internal */
export const Member$outboundSchema: z.ZodType<Member$Outbound, z.ZodTypeDef, Member> = z.object({});
...
> = z.object({
    acceptedPaymentMethods: z
        .nullable(z.array(InvoiceCreateRequestAcceptedPaymentMethods$inboundSchema))
        .optional(),
    attachments: z
        .nullable(
            ThirtySixb041d426951ffff76360faf03ef8ae938bed9739e6ad9f51acb982782296a2$inboundSchema
...
> = z.object({
    acceptedPaymentMethods: z
        .nullable(z.array(InvoiceCreateRequestAcceptedPaymentMethods$outboundSchema))
        .optional(),
    attachments: z
        .nullable(
            ThirtySixb041d426951ffff76360faf03ef8ae938bed9739e6ad9f51acb982782296a2$outboundSchema
