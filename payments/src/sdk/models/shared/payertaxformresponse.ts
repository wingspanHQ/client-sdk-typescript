...
export type PayerTaxFormResponseStatus = ClosedEnum<
...
export type PayerTaxFormResponseType = ClosedEnum<
...
export namespace PayerTaxFormResponseDeliveryMethod$ {
  ...
  export const outboundSchema =
    PayerTaxFormResponseDeliveryMethod$outboundSchema;
}

/** @internal */
export const DeprecatedTaxForm$inboundSchema: z.ZodType<
  DeprecatedTaxForm,
  z.ZodTypeDef,
  unknown
> = z.object({});
...
> = z.object({
  ...
  recipientVerification: z.nullable(RecipientVerification$inboundSchema)
    .optional(),
  ...
  unsyncedRecipientData: z.nullable(TaxFormRedactedSubmissionData$inboundSchema)
    .optional(),
...
> = z.object({
  ...
  recipientReadyToSubmitW9: z.boolean(),
  recipientSyncEnabled: z.boolean(),
  recipientVerification: z.nullable(RecipientVerification$outboundSchema)
    .optional(),
  ...
  unsyncedRecipientData: z.nullable(
    TaxFormRedactedSubmissionData$outboundSchema,
  ).optional(),
  unsyncedUpdateAvailable: z.nullable(z.boolean()).optional(),
  updatedAt: z.string(),
