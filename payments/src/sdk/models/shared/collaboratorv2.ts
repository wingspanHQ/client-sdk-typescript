...
export type CollaboratorV2TaxStatus = ClosedEnum<typeof CollaboratorV2TaxStatus>;
...
/** @internal */
export const CollaboratorV2Status$inboundSchema: z.ZodNativeEnum<typeof CollaboratorV2Status> =
    z.nativeEnum(CollaboratorV2Status);

/** @internal */
export const CollaboratorV2Status$outboundSchema: z.ZodNativeEnum<typeof CollaboratorV2Status> =
...
/** @internal */
export const CollaboratorV2$inboundSchema: z.ZodType<CollaboratorV2, z.ZodTypeDef, unknown> =
    z.object({
