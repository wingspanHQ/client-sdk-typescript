...
export namespace GetClientDeductionRequest$ {
    ...
    export const inboundSchema: z.ZodType<GetClientDeductionRequest, z.ZodTypeDef, Inbound> = z
        .object({
            id: z.string(),
        })
        .transform((v) => {
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, GetClientDeductionRequest> = z
        .object({
            id: z.string(),
        })
        .transform((v) => {
...
export namespace GetClientDeductionResponse$ {
    ...
    export const inboundSchema: z.ZodType<GetClientDeductionResponse, z.ZodTypeDef, Inbound> = z
        .object({
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, GetClientDeductionResponse> = z
        .object({
            contentType: z.string(),
