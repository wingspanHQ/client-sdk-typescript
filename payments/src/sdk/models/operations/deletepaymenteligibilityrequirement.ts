...
/** @internal */
export const DeletePaymentEligibilityRequirementRequest$inboundSchema:
  z.ZodType<DeletePaymentEligibilityRequirementRequest, z.ZodTypeDef, unknown> =
    z.object({
      id: z.string(),
    });
...
/** @internal */
export const DeletePaymentEligibilityRequirementRequest$outboundSchema:
  z.ZodType<
...
export namespace DeletePaymentEligibilityRequirementRequest$ {
  ...
  export const inboundSchema =
    DeletePaymentEligibilityRequirementRequest$inboundSchema;
  /** @deprecated use `DeletePaymentEligibilityRequirementRequest$outboundSchema` instead. */
  export const outboundSchema =
    DeletePaymentEligibilityRequirementRequest$outboundSchema;
...
/** @internal */
export const DeletePaymentEligibilityRequirementResponse$outboundSchema:
  z.ZodType<
...
export namespace DeletePaymentEligibilityRequirementResponse$ {
  ...
  export const inboundSchema =
    DeletePaymentEligibilityRequirementResponse$inboundSchema;
