 ...
 */
export async function documentSigningAndEligibilityDelete(
  client$: PaymentsCore,
...
> {
  ...
  const parsed$ = schemas$.safeParse(
    input$,
    (value$) =>
      operations.DeleteEligibilityRequirementRequest$outboundSchema.parse(
        value$,
      ),
  ...
  >(
    m$.json(
      200,
      operations.DeleteEligibilityRequirementResponse$inboundSchema,
      { key: "classes" },
    ),
