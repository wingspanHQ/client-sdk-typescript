...
export class GetPaymentsBulkInvoiceBatchBatchIdRequest extends SpeakeasyBase {
    /**
...
export class GetPaymentsBulkInvoiceBatchBatchIdResponse extends SpeakeasyBase {
    /**
