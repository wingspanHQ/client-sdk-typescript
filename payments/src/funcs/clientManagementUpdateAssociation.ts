 ...
 */
export async function clientManagementUpdateAssociation(
  client: PaymentsCore,
...
> {
  ...
  const body = encodeJSON("body", payload.MemberClientUpdateRequest, {
    explode: true,
  });
  ...
  >(
    M.json(
      200,
      operations.UpdateMemberClientAssociationResponse$inboundSchema,
