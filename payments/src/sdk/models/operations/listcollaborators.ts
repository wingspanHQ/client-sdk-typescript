...
export namespace ListCollaboratorsResponse$ {
    export type Inbound = {
        ...
        StatusCode: number;
        RawResponse: Response;
        classes?: Array<shared.CollaboratorV2$.Inbound> | undefined;
    };

    export const inboundSchema: z.ZodType<ListCollaboratorsResponse, z.ZodTypeDef, Inbound> = z
        .object({
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, ListCollaboratorsResponse> = z
        .object({
            contentType: z.string(),
            statusCode: z.number().int(),
