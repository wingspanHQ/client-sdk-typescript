...
export type DeductionUpdateRequestCurrency = ClosedEnum<typeof DeductionUpdateRequestCurrency>;

export const DeductionUpdateRequestType = {
    PrePayment: "PrePayment",
    PostPayment: "PostPayment",
} as const;
export type DeductionUpdateRequestType = ClosedEnum<typeof DeductionUpdateRequestType>;
...
> = z.object({
    amount: z.nullable(z.number()).optional(),
    currency: z.nullable(DeductionUpdateRequestCurrency$outboundSchema).optional(),
    name: z.nullable(z.string()).optional(),
    priority: z.nullable(z.number()).optional(),
    sourceInvoiceId: z.nullable(z.string()).optional(),
    startDate: z.nullable(z.string()).optional(),
