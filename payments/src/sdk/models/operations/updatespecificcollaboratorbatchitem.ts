...
/** @internal */
export const UpdateSpecificCollaboratorBatchItemRequest$inboundSchema: z.ZodType<
...
/** @internal */
export const UpdateSpecificCollaboratorBatchItemRequest$outboundSchema: z.ZodType<
    UpdateSpecificCollaboratorBatchItemRequest$Outbound,
    z.ZodTypeDef,
    UpdateSpecificCollaboratorBatchItemRequest
> = z
    .object({
        bulkCollaboratorItemUpdate: shared.BulkCollaboratorItemUpdate$outboundSchema.optional(),
        batchId: z.string(),
        batchItemId: z.string(),
    })
    .transform((v) => {
...
export namespace UpdateSpecificCollaboratorBatchItemRequest$ {
    ...
    export const inboundSchema = UpdateSpecificCollaboratorBatchItemRequest$inboundSchema;
    /** @deprecated use `UpdateSpecificCollaboratorBatchItemRequest$outboundSchema` instead. */
    export const outboundSchema = UpdateSpecificCollaboratorBatchItemRequest$outboundSchema;
...
/** @internal */
export const UpdateSpecificCollaboratorBatchItemResponse$inboundSchema: z.ZodType<
...
/** @internal */
export const UpdateSpecificCollaboratorBatchItemResponse$outboundSchema: z.ZodType<
...
export namespace UpdateSpecificCollaboratorBatchItemResponse$ {
    ...
    export const inboundSchema = UpdateSpecificCollaboratorBatchItemResponse$inboundSchema;
    /** @deprecated use `UpdateSpecificCollaboratorBatchItemResponse$outboundSchema` instead. */
    export const outboundSchema = UpdateSpecificCollaboratorBatchItemResponse$outboundSchema;
