...
export class GetPaymentsBulkCollaboratorBatchBatchIdItemRequest extends SpeakeasyBase {
    /**
...
export class GetPaymentsBulkCollaboratorBatchBatchIdItemResponse extends SpeakeasyBase {
    /**
