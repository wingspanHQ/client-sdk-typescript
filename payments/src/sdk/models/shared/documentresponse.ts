...
/** @internal */
export const DocumentResponseStatus$inboundSchema: z.ZodNativeEnum<typeof DocumentResponseStatus> =
    z.nativeEnum(DocumentResponseStatus);

/** @internal */
export const DocumentResponseStatus$outboundSchema: z.ZodNativeEnum<typeof DocumentResponseStatus> =
...
/** @internal */
export const DocumentResponse$inboundSchema: z.ZodType<DocumentResponse, z.ZodTypeDef, unknown> =
    z.object({
        clientId: z.string(),
        documentId: z.string(),
