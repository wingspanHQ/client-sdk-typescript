...
export type GetUsersUserMemberSubscriptionIdRequest = {
    /**
     * Unique identifier
     */
    id: string;
...
export type GetUsersUserMemberSubscriptionIdResponse = {
    /**
...
/** @internal */
export namespace GetUsersUserMemberSubscriptionIdRequest$ {
    export type Inbound = {
        id: string;
    };
...
/** @internal */
export namespace GetUsersUserMemberSubscriptionIdResponse$ {
    export type Inbound = {
        ContentType: string;
        StatusCode: number;
        RawResponse: Response;
