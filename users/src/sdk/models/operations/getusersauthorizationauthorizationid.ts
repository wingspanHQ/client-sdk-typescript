...
export type GetUsersAuthorizationAuthorizationIdRequest = {
    /**
     * Authorization Id
     */
...
export type GetUsersAuthorizationAuthorizationIdResponse = {
    /**
...
/** @internal */
export namespace GetUsersAuthorizationAuthorizationIdRequest$ {
    export type Inbound = {
        authorizationId: string;
    };
...
/** @internal */
export namespace GetUsersAuthorizationAuthorizationIdResponse$ {
    export type Inbound = {
