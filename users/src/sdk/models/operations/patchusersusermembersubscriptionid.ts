...
export type PatchUsersUserMemberSubscriptionIdRequest = {
...
export type PatchUsersUserMemberSubscriptionIdResponse = {
    /**
...
/** @internal */
export namespace PatchUsersUserMemberSubscriptionIdRequest$ {
    export type Inbound = {
...
/** @internal */
export namespace PatchUsersUserMemberSubscriptionIdResponse$ {
    export type Inbound = {
        ContentType: string;
        StatusCode: number;
        RawResponse: Response;
