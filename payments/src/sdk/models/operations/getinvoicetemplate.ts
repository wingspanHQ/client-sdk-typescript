...
export namespace GetInvoiceTemplateRequest$ {
    ...
    export const inboundSchema: z.ZodType<GetInvoiceTemplateRequest, z.ZodTypeDef, Inbound> = z
        .object({
            id: z.string(),
        })
        .transform((v) => {
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, GetInvoiceTemplateRequest> = z
        .object({
            id: z.string(),
        })
        .transform((v) => {
...
export namespace GetInvoiceTemplateResponse$ {
    ...
    export const inboundSchema: z.ZodType<GetInvoiceTemplateResponse, z.ZodTypeDef, Inbound> = z
        .object({
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, GetInvoiceTemplateResponse> = z
        .object({
            contentType: z.string(),
