...
/** @internal */
export const ClientUserAccountType$inboundSchema: z.ZodNativeEnum<
  typeof ClientUserAccountType
> = z.nativeEnum(ClientUserAccountType);

/** @internal */
export const ClientUserAccountType$outboundSchema: z.ZodNativeEnum<
  typeof ClientUserAccountType
...
/** @internal */
export const MemberClientStatus$inboundSchema: z.ZodNativeEnum<
  typeof MemberClientStatus
> = z.nativeEnum(MemberClientStatus);

/** @internal */
export const MemberClientStatus$outboundSchema: z.ZodNativeEnum<
  typeof MemberClientStatus
...
/** @internal */
export const MemberClientTaxStatus$inboundSchema: z.ZodNativeEnum<
  typeof MemberClientTaxStatus
> = z.nativeEnum(MemberClientTaxStatus);

/** @internal */
export const MemberClientTaxStatus$outboundSchema: z.ZodNativeEnum<
  typeof MemberClientTaxStatus
...
/** @internal */
export const MemberClient$inboundSchema: z.ZodType<
  MemberClient,
  z.ZodTypeDef,
  unknown
> = z.object({
...
export function memberClientToJSON(memberClient: MemberClient): string {
  return JSON.stringify(MemberClient$outboundSchema.parse(memberClient));
}

export function memberClientFromJSON(
  jsonString: string,
): SafeParseResult<MemberClient, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => MemberClient$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'MemberClient' from JSON`,
  );
}
