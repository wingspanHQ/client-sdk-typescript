 ...
 */
export async function invoiceManagementUpdateTemplate(
  client: PaymentsCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.UpdateInvoiceTemplateRequest$outboundSchema.parse(value),
  ...
  const body = encodeJSON("body", payload.InvoiceTemplateUpdateRequest, {
    explode: true,
  });
