...
export class DeletePaymentsBulkCollaboratorBatchBatchIdRequest extends SpeakeasyBase {
    /**
...
export class DeletePaymentsBulkCollaboratorBatchBatchIdResponse extends SpeakeasyBase {
    /**
