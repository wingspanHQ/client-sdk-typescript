...
export type PayrollSettingsUpdateStatus = ClosedEnum<typeof PayrollSettingsUpdateStatus>;

export const PayrollSettingsUpdateWorkflow = {
    SingleStage: "SingleStage",
    DualStage: "DualStage",
} as const;
export type PayrollSettingsUpdateWorkflow = ClosedEnum<typeof PayrollSettingsUpdateWorkflow>;
