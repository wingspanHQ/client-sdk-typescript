...
/** @internal */
export const CreateSpecificCollaboratorBatchItemRequest$inboundSchema: z.ZodType<
...
/** @internal */
export const CreateSpecificCollaboratorBatchItemRequest$outboundSchema: z.ZodType<
    CreateSpecificCollaboratorBatchItemRequest$Outbound,
    z.ZodTypeDef,
    CreateSpecificCollaboratorBatchItemRequest
> = z
    .object({
        bulkCollaboratorItemCreate: shared.BulkCollaboratorItemCreate$outboundSchema.optional(),
        batchId: z.string(),
    })
    .transform((v) => {
        return remap$(v, {
...
export namespace CreateSpecificCollaboratorBatchItemRequest$ {
    ...
    export const inboundSchema = CreateSpecificCollaboratorBatchItemRequest$inboundSchema;
    /** @deprecated use `CreateSpecificCollaboratorBatchItemRequest$outboundSchema` instead. */
    export const outboundSchema = CreateSpecificCollaboratorBatchItemRequest$outboundSchema;
...
/** @internal */
export const CreateSpecificCollaboratorBatchItemResponse$inboundSchema: z.ZodType<
...
/** @internal */
export const CreateSpecificCollaboratorBatchItemResponse$outboundSchema: z.ZodType<
...
export namespace CreateSpecificCollaboratorBatchItemResponse$ {
    ...
    export const inboundSchema = CreateSpecificCollaboratorBatchItemResponse$inboundSchema;
    /** @deprecated use `CreateSpecificCollaboratorBatchItemResponse$outboundSchema` instead. */
    export const outboundSchema = CreateSpecificCollaboratorBatchItemResponse$outboundSchema;
