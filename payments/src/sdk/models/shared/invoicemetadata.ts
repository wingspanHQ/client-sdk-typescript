...
/** @internal */
export const PayoutPendingReason$inboundSchema: z.ZodNativeEnum<typeof PayoutPendingReason> =
    z.nativeEnum(PayoutPendingReason);

/** @internal */
export const PayoutPendingReason$outboundSchema: z.ZodNativeEnum<typeof PayoutPendingReason> =
...
/** @internal */
export const PendingStatusReason$inboundSchema: z.ZodNativeEnum<typeof PendingStatusReason> =
    z.nativeEnum(PendingStatusReason);

/** @internal */
export const PendingStatusReason$outboundSchema: z.ZodNativeEnum<typeof PendingStatusReason> =
...
/** @internal */
export const InvoiceMetadata$inboundSchema: z.ZodType<InvoiceMetadata, z.ZodTypeDef, unknown> =
    z.object({
...
> = z.object({
    depositNote: z.nullable(z.string()).optional(),
    invoiceDate: z.nullable(z.string()).optional(),
    payoutPendingReason: z.nullable(PayoutPendingReason$outboundSchema).optional(),
    pendingStatusReason: z.nullable(PendingStatusReason$outboundSchema).optional(),
    purchaseOrderNumber: z.nullable(z.string()).optional(),
});
