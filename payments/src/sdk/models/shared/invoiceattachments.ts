...
> = z.object({
    ...
    customAttachmentInfo: z.nullable(z.array(InvoiceAttachmentFile$inboundSchema)).optional(),
...
> = z.object({
    customAttachmentIds: z.nullable(z.array(z.string())).optional(),
    customAttachmentInfo: z.nullable(z.array(InvoiceAttachmentFile$outboundSchema)).optional(),
    invoiceLink: z.nullable(z.string()).optional(),
    invoicePdf: z.nullable(z.string()).optional(),
    receiptPdf: z.nullable(z.string()).optional(),
});
