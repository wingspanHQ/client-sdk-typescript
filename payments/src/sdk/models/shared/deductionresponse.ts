...
export type DeductionResponseCurrency = ClosedEnum<typeof DeductionResponseCurrency>;
...
export type DeductionResponseStatus = ClosedEnum<typeof DeductionResponseStatus>;
...
/** @internal */
export const DeductionResponseType$inboundSchema: z.ZodNativeEnum<typeof DeductionResponseType> =
    z.nativeEnum(DeductionResponseType);

/** @internal */
export const DeductionResponseType$outboundSchema: z.ZodNativeEnum<typeof DeductionResponseType> =
...
/** @internal */
export const DeductionResponse$inboundSchema: z.ZodType<DeductionResponse, z.ZodTypeDef, unknown> =
    z.object({
        amount: z.number(),
        ...
        disbursement: z.nullable(PostPaymentDeductionDisbursement$inboundSchema).optional(),
...
> = z.object({
    ...
    deductionId: z.string(),
    deductionTemplateId: z.nullable(z.string()).optional(),
    disbursement: z.nullable(PostPaymentDeductionDisbursement$outboundSchema).optional(),
    eventActors: z.record(z.string()),
    labels: z.record(z.string()),
    memberId: z.string(),
    name: z.string(),
