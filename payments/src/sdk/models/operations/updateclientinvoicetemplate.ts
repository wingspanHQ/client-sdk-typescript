...
export namespace UpdateClientInvoiceTemplateRequest$ {
    ...
    export const outboundSchema = UpdateClientInvoiceTemplateRequest$outboundSchema;
...
export namespace UpdateClientInvoiceTemplateResponse$ {
    ...
    export const inboundSchema = UpdateClientInvoiceTemplateResponse$inboundSchema;
    /** @deprecated use `UpdateClientInvoiceTemplateResponse$outboundSchema` instead. */
    export const outboundSchema = UpdateClientInvoiceTemplateResponse$outboundSchema;
