...
export namespace InvoiceTemplateUpdateRequestStatus$ {
  ...
  export const outboundSchema =
    InvoiceTemplateUpdateRequestStatus$outboundSchema;
}
...
> = z.object({
  ...
  status: z.nullable(InvoiceTemplateUpdateRequestStatus$inboundSchema)
    .optional(),
});
...
> = z.object({
  ...
  scheduleDates: z.nullable(z.array(ScheduleDateUpdate$outboundSchema))
    .optional(),
  sendEmails: z.nullable(z.boolean()).optional(),
  status: z.nullable(InvoiceTemplateUpdateRequestStatus$outboundSchema)
    .optional(),
});
...
export function invoiceTemplateUpdateRequestToJSON(
  invoiceTemplateUpdateRequest: InvoiceTemplateUpdateRequest,
): string {
  return JSON.stringify(
    InvoiceTemplateUpdateRequest$outboundSchema.parse(
      invoiceTemplateUpdateRequest,
    ),
  );
}

export function invoiceTemplateUpdateRequestFromJSON(
  jsonString: string,
): SafeParseResult<InvoiceTemplateUpdateRequest, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => InvoiceTemplateUpdateRequest$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'InvoiceTemplateUpdateRequest' from JSON`,
  );
}
