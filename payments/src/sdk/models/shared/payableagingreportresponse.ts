...
export type PayableAgingReportResponseStatus = ClosedEnum<typeof PayableAgingReportResponseStatus>;
...
> = z.object({
    ...
    invoicePdf: z.string(),
    labels: z.nullable(z.lazy(() => PayableAgingReportResponseLabels$inboundSchema)).optional(),
...
> = z.object({
    ...
    invoiceNumber: z.string(),
    invoicePdf: z.string(),
    labels: z.nullable(z.lazy(() => PayableAgingReportResponseLabels$outboundSchema)).optional(),
