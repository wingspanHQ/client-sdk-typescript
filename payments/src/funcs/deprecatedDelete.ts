 ...
 */
export async function deprecatedDelete(
  client: PaymentsCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.DeleteCustomDataCollaboratorMemberRequest$outboundSchema.parse(
        value,
      ),
  ...
  >(
    M.json(
      200,
      operations.DeleteCustomDataCollaboratorMemberResponse$inboundSchema,
      { key: "AdditionalData" },
    ),
