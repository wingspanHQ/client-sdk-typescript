...
/** @internal */
export const ClientInvoiceDataCreateRequestCurrency$inboundSchema: z.ZodNativeEnum<
    typeof ClientInvoiceDataCreateRequestCurrency
> = z.nativeEnum(ClientInvoiceDataCreateRequestCurrency);

/** @internal */
export const ClientInvoiceDataCreateRequestCurrency$outboundSchema: z.ZodNativeEnum<
    typeof ClientInvoiceDataCreateRequestCurrency
...
export namespace ClientInvoiceDataCreateRequestCurrency$ {
    ...
    export const inboundSchema = ClientInvoiceDataCreateRequestCurrency$inboundSchema;
    /** @deprecated use `ClientInvoiceDataCreateRequestCurrency$outboundSchema` instead. */
    export const outboundSchema = ClientInvoiceDataCreateRequestCurrency$outboundSchema;
}
...
> = z.object({
    ...
    currency: z.nullable(ClientInvoiceDataCreateRequestCurrency$inboundSchema).optional(),
...
> = z.object({
    ...
    currency: z.nullable(ClientInvoiceDataCreateRequestCurrency$outboundSchema).optional(),
    dueDate: z.nullable(z.string()).optional(),
