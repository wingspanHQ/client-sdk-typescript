...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.CreatePayableBatchItemRequest$outboundSchema.parse(value),
  ...
  const body = encodeJSON("body", payload.BulkPayableItemCreate, {
    explode: true,
  });
  ...
  const path = pathToFunc("/payments/bulk/payable/batch/{batchId}/item")(
    pathParams,
  );
