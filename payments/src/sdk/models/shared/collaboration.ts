...
/** @internal */
export const CollaborationStatus$inboundSchema: z.ZodNativeEnum<typeof CollaborationStatus> =
    z.nativeEnum(CollaborationStatus);

/** @internal */
export const CollaborationStatus$outboundSchema: z.ZodNativeEnum<typeof CollaborationStatus> =
...
/** @internal */
export const Collaboration$inboundSchema: z.ZodType<Collaboration, z.ZodTypeDef, unknown> =
    z.object({
