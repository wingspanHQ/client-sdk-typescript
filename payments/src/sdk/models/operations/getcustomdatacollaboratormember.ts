...
export namespace GetCustomDataCollaboratorMemberRequest$ {
    ...
    export const inboundSchema = GetCustomDataCollaboratorMemberRequest$inboundSchema;
    /** @deprecated use `GetCustomDataCollaboratorMemberRequest$outboundSchema` instead. */
    export const outboundSchema = GetCustomDataCollaboratorMemberRequest$outboundSchema;
...
export namespace GetCustomDataCollaboratorMemberResponse$ {
    ...
    export const inboundSchema = GetCustomDataCollaboratorMemberResponse$inboundSchema;
    /** @deprecated use `GetCustomDataCollaboratorMemberResponse$outboundSchema` instead. */
    export const outboundSchema = GetCustomDataCollaboratorMemberResponse$outboundSchema;
