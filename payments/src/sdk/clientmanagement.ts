...
export class ClientManagement extends ClientSDK {
  ...
  async create(
    ...
    return unwrapAsync(clientManagementCreate(
      this,
      request,
      options,
    ));
  ...
  async deleteAssociation(
    ...
    return unwrapAsync(clientManagementDeleteAssociation(
      this,
      request,
      options,
    ));
  ...
  async deleteClientDeduction(
    ...
    return unwrapAsync(clientManagementDeleteClientDeduction(
      this,
      request,
      options,
    ));
  ...
  async establish(
    ...
    return unwrapAsync(clientManagementEstablish(
      this,
      request,
      options,
    ));
  ...
  async getAssociation(
    ...
    return unwrapAsync(clientManagementGetAssociation(
      this,
      request,
      options,
    ));
  ...
  async getClientDeduction(
    ...
    return unwrapAsync(clientManagementGetClientDeduction(
      this,
      request,
      options,
    ));
  ...
  async list(
    ...
    return unwrapAsync(clientManagementList(
      this,
      options,
    ));
  }
  ...
  async listAssociations(
    ...
    return unwrapAsync(clientManagementListAssociations(
      this,
      options,
    ));
  }
  ...
  async listClientDeduction(
    ...
    return unwrapAsync(clientManagementListClientDeduction(
      this,
      options,
    ));
  }
  ...
  async listSpecificClientDetail(
    ...
    return unwrapAsync(clientManagementListSpecificClientDetail(
      this,
      request,
      options,
    ));
  ...
  async updateAssociation(
    ...
    return unwrapAsync(clientManagementUpdateAssociation(
      this,
      request,
      options,
    ));
  ...
  async updateClientDeduction(
    ...
    return unwrapAsync(clientManagementUpdateClientDeduction(
      this,
      request,
      options,
    ));
