 ...
 */
export async function invoiceManagementUpdateClient(
  client$: PaymentsCore,
...
> {
  ...
  const parsed$ = schemas$.safeParse(
    input$,
    (value$) =>
      operations.UpdateClientInvoiceTemplateRequest$outboundSchema.parse(
        value$,
      ),
  ...
  const body$ = encodeJSON$(
    "body",
    payload$.ClientInvoiceTemplateUpdateRequest,
    { explode: true },
  );
  ...
  const path$ = pathToFunc("/payments/client/invoice-template/{id}")(
    pathParams$,
  );
