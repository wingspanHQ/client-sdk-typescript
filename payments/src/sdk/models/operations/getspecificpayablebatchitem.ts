...
export namespace GetSpecificPayableBatchItemRequest$ {
    ...
    export const outboundSchema = GetSpecificPayableBatchItemRequest$outboundSchema;
...
export namespace GetSpecificPayableBatchItemResponse$ {
    ...
    export const inboundSchema = GetSpecificPayableBatchItemResponse$inboundSchema;
    /** @deprecated use `GetSpecificPayableBatchItemResponse$outboundSchema` instead. */
    export const outboundSchema = GetSpecificPayableBatchItemResponse$outboundSchema;
