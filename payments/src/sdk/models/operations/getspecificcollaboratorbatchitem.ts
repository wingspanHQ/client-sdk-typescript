...
export namespace GetSpecificCollaboratorBatchItemRequest$ {
    ...
    export const inboundSchema = GetSpecificCollaboratorBatchItemRequest$inboundSchema;
    /** @deprecated use `GetSpecificCollaboratorBatchItemRequest$outboundSchema` instead. */
    export const outboundSchema = GetSpecificCollaboratorBatchItemRequest$outboundSchema;
...
export namespace GetSpecificCollaboratorBatchItemResponse$ {
    ...
    export const inboundSchema = GetSpecificCollaboratorBatchItemResponse$inboundSchema;
    /** @deprecated use `GetSpecificCollaboratorBatchItemResponse$outboundSchema` instead. */
    export const outboundSchema = GetSpecificCollaboratorBatchItemResponse$outboundSchema;
