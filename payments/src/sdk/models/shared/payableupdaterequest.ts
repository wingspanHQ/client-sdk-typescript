...
export type PayableUpdateRequestStatus = ClosedEnum<
...
/** @internal */
export const PayableUpdateRequestAcceptedPaymentMethods$inboundSchema:
  z.ZodNativeEnum<typeof PayableUpdateRequestAcceptedPaymentMethods> = z
    .nativeEnum(PayableUpdateRequestAcceptedPaymentMethods);

/** @internal */
export const PayableUpdateRequestAcceptedPaymentMethods$outboundSchema:
  z.ZodNativeEnum<typeof PayableUpdateRequestAcceptedPaymentMethods> =
...
export namespace PayableUpdateRequestAcceptedPaymentMethods$ {
  ...
  export const outboundSchema =
    PayableUpdateRequestAcceptedPaymentMethods$outboundSchema;
}
...
/** @internal */
export const PaymentMethods$inboundSchema: z.ZodNativeEnum<
  typeof PaymentMethods
> = z.nativeEnum(PaymentMethods);

/** @internal */
export const PaymentMethods$outboundSchema: z.ZodNativeEnum<
  typeof PaymentMethods
...
> = z.object({
  acceptedPaymentMethods: z.nullable(
    z.array(PayableUpdateRequestAcceptedPaymentMethods$inboundSchema),
  ).optional(),
  attachments: z.nullable(
    ThirtySixb041d426951ffff76360faf03ef8ae938bed9739e6ad9f51acb982782296a2$inboundSchema,
  ).optional(),
  chargedFees: z.nullable(Fees$inboundSchema).optional(),
  client: z.nullable(z.lazy(() => PayableUpdateRequestClient$inboundSchema))
    .optional(),
  collaborators: z.nullable(
    z.array(InvoiceCollaboratorUpdateRequest$inboundSchema),
  ).optional(),
  ...
  lineItems: z.nullable(z.array(InvoiceLineItemsCreateRequest$inboundSchema))
    .optional(),
  member: z.nullable(z.lazy(() => PayableUpdateRequestMember$inboundSchema))
    .optional(),
...
export type PayableUpdateRequest$Outbound = {
  ...
  collaborators?:
    | Array<InvoiceCollaboratorUpdateRequest$Outbound>
    | null
    | undefined;
...
> = z.object({
  acceptedPaymentMethods: z.nullable(
    z.array(PayableUpdateRequestAcceptedPaymentMethods$outboundSchema),
  ).optional(),
  attachments: z.nullable(
    ThirtySixb041d426951ffff76360faf03ef8ae938bed9739e6ad9f51acb982782296a2$outboundSchema,
  ).optional(),
  chargedFees: z.nullable(Fees$outboundSchema).optional(),
  client: z.nullable(z.lazy(() => PayableUpdateRequestClient$outboundSchema))
    .optional(),
  collaborators: z.nullable(
    z.array(InvoiceCollaboratorUpdateRequest$outboundSchema),
  ).optional(),
  ...
  lineItems: z.nullable(z.array(InvoiceLineItemsCreateRequest$outboundSchema))
    .optional(),
  member: z.nullable(z.lazy(() => PayableUpdateRequestMember$outboundSchema))
    .optional(),
  memberClientId: z.nullable(z.string()).optional(),
