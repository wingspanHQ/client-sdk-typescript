 ...
 */
export async function bulkOperationsGetSpecificCollaboratorItem(
  client: PaymentsCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetSpecificCollaboratorBatchItemRequest$outboundSchema.parse(
        value,
      ),
  ...
  >(
    M.json(
      200,
      operations.GetSpecificCollaboratorBatchItemResponse$inboundSchema,
