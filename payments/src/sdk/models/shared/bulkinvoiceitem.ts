...
/** @internal */
export const AcceptedPaymentMethods$inboundSchema: z.ZodNativeEnum<typeof AcceptedPaymentMethods> =
    z.nativeEnum(AcceptedPaymentMethods);

/** @internal */
export const AcceptedPaymentMethods$outboundSchema: z.ZodNativeEnum<typeof AcceptedPaymentMethods> =
...
/** @internal */
export const InvoiceStatus$inboundSchema: z.ZodNativeEnum<typeof InvoiceStatus> =
    z.nativeEnum(InvoiceStatus);

/** @internal */
export const InvoiceStatus$outboundSchema: z.ZodNativeEnum<typeof InvoiceStatus> =
...
/** @internal */
export const BulkInvoiceItemStatus$inboundSchema: z.ZodNativeEnum<typeof BulkInvoiceItemStatus> =
    z.nativeEnum(BulkInvoiceItemStatus);

/** @internal */
export const BulkInvoiceItemStatus$outboundSchema: z.ZodNativeEnum<typeof BulkInvoiceItemStatus> =
...
/** @internal */
export const BulkInvoiceItem$inboundSchema: z.ZodType<BulkInvoiceItem, z.ZodTypeDef, unknown> =
    z.object({
        acceptedPaymentMethods: z
            .nullable(z.array(AcceptedPaymentMethods$inboundSchema))
            .optional(),
        amount: z.number(),
...
export const BulkInvoiceItem$outboundSchema: z.ZodType<
    ...
    BulkInvoiceItem
> = z.object({
    acceptedPaymentMethods: z.nullable(z.array(AcceptedPaymentMethods$outboundSchema)).optional(),
    amount: z.number(),
    bulkInvoiceBatchId: z.string(),
    bulkInvoiceItemId: z.string(),
    bulkInvoiceItemMergeKey: z.nullable(z.string()).optional(),
    ...
    memberId: z.string(),
    metadata: z
        .nullable(C1b9877fd1d35a4292006c3c09941c1c5c21bbe2e0e87488661804eebf2a3e4a$outboundSchema)
        .optional(),
    paidDate: z.string(),
    projectName: z.nullable(z.string()).optional(),
    reimbursableExpense: z.nullable(z.boolean()).optional(),
