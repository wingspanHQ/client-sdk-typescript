...
/** @internal */
export const PayoutSettingsUpdatePayoutPreferences$inboundSchema: z.ZodNativeEnum<
    typeof PayoutSettingsUpdatePayoutPreferences
> = z.nativeEnum(PayoutSettingsUpdatePayoutPreferences);

/** @internal */
export const PayoutSettingsUpdatePayoutPreferences$outboundSchema: z.ZodNativeEnum<
    typeof PayoutSettingsUpdatePayoutPreferences
...
export namespace PayoutSettingsUpdatePayoutPreferences$ {
    ...
    export const inboundSchema = PayoutSettingsUpdatePayoutPreferences$inboundSchema;
    /** @deprecated use `PayoutSettingsUpdatePayoutPreferences$outboundSchema` instead. */
    export const outboundSchema = PayoutSettingsUpdatePayoutPreferences$outboundSchema;
}
...
export const PayoutSettingsUpdate$inboundSchema: z.ZodType<
    ...
    unknown
> = z.object({
    payoutDestinations: z.nullable(z.array(PayoutDestinationUpdate$inboundSchema)).optional(),
    payoutPreferences: z.nullable(PayoutSettingsUpdatePayoutPreferences$inboundSchema).optional(),
});
...
export const PayoutSettingsUpdate$outboundSchema: z.ZodType<
    ...
    PayoutSettingsUpdate
> = z.object({
    payoutDestinations: z.nullable(z.array(PayoutDestinationUpdate$outboundSchema)).optional(),
    payoutPreferences: z.nullable(PayoutSettingsUpdatePayoutPreferences$outboundSchema).optional(),
});
