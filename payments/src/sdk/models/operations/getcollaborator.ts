...
export namespace GetCollaboratorRequest$ {
    ...
    export const inboundSchema: z.ZodType<GetCollaboratorRequest, z.ZodTypeDef, Inbound> = z
        .object({
            id: z.string(),
        })
        .transform((v) => {
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, GetCollaboratorRequest> = z
        .object({
            id: z.string(),
        })
        .transform((v) => {
...
export namespace GetCollaboratorResponse$ {
    ...
    export const inboundSchema: z.ZodType<GetCollaboratorResponse, z.ZodTypeDef, Inbound> = z
        .object({
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, GetCollaboratorResponse> = z
        .object({
