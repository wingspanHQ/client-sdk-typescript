 ...
 */
export async function invoiceManagementExecute(
  client: PaymentsCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ExecuteClientInvoicePaymentRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/payments/client/invoice/{invoice_id}/pay")(
    pathParams,
  );
