...
/** @internal */
export const ClientInvoiceAcceptedPaymentMethods$outboundSchema:
  z.ZodNativeEnum<typeof ClientInvoiceAcceptedPaymentMethods> =
...
export namespace ClientInvoiceAcceptedPaymentMethods$ {
  ...
  export const outboundSchema =
    ClientInvoiceAcceptedPaymentMethods$outboundSchema;
}
...
/** @internal */
export const ClientInvoiceStatus$inboundSchema: z.ZodNativeEnum<
  typeof ClientInvoiceStatus
> = z.nativeEnum(ClientInvoiceStatus);

/** @internal */
export const ClientInvoiceStatus$outboundSchema: z.ZodNativeEnum<
  typeof ClientInvoiceStatus
...
/** @internal */
export const ClientInvoice$inboundSchema: z.ZodType<
  ClientInvoice,
  z.ZodTypeDef,
  unknown
> = z.object({
  acceptedPaymentMethods: z.nullable(
    z.array(ClientInvoiceAcceptedPaymentMethods$inboundSchema),
  ).optional(),
...
> = z.object({
  acceptedPaymentMethods: z.nullable(
    z.array(ClientInvoiceAcceptedPaymentMethods$outboundSchema),
  ).optional(),
  accountId: z.nullable(z.string()).optional(),
  additionalRecipientEmails: z.array(z.string()),
  amount: z.number(),
