 ...
 */
export async function bulkOperationsUpdateClient(
  client$: PaymentsCore,
...
> {
  ...
  const parsed$ = schemas$.safeParse(
    input$,
    (value$) =>
      operations.UpdateClientBatchRequest$outboundSchema.parse(value$),
  ...
  const path$ = pathToFunc("/payments/bulk/client/batch/{batchId}")(
    pathParams$,
  );
