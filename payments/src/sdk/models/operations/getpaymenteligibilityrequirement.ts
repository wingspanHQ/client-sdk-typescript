...
export namespace GetPaymentEligibilityRequirementRequest$ {
    ...
    export const inboundSchema = GetPaymentEligibilityRequirementRequest$inboundSchema;
    /** @deprecated use `GetPaymentEligibilityRequirementRequest$outboundSchema` instead. */
    export const outboundSchema = GetPaymentEligibilityRequirementRequest$outboundSchema;
...
export namespace GetPaymentEligibilityRequirementResponse$ {
    ...
    export const inboundSchema = GetPaymentEligibilityRequirementResponse$inboundSchema;
    /** @deprecated use `GetPaymentEligibilityRequirementResponse$outboundSchema` instead. */
    export const outboundSchema = GetPaymentEligibilityRequirementResponse$outboundSchema;
