...
/** @internal */
export const TaxFormRedactedSubmissionDataDeliveryMethod$inboundSchema:
  z.ZodNativeEnum<typeof TaxFormRedactedSubmissionDataDeliveryMethod> = z
    .nativeEnum(TaxFormRedactedSubmissionDataDeliveryMethod);

/** @internal */
export const TaxFormRedactedSubmissionDataDeliveryMethod$outboundSchema:
  z.ZodNativeEnum<typeof TaxFormRedactedSubmissionDataDeliveryMethod> =
...
export namespace TaxFormRedactedSubmissionDataDeliveryMethod$ {
  ...
  export const outboundSchema =
    TaxFormRedactedSubmissionDataDeliveryMethod$outboundSchema;
}
...
export function taxFormRedactedSubmissionDataToJSON(
  taxFormRedactedSubmissionData: TaxFormRedactedSubmissionData,
): string {
  return JSON.stringify(
    TaxFormRedactedSubmissionData$outboundSchema.parse(
      taxFormRedactedSubmissionData,
    ),
  );
}

export function taxFormRedactedSubmissionDataFromJSON(
  jsonString: string,
): SafeParseResult<TaxFormRedactedSubmissionData, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => TaxFormRedactedSubmissionData$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'TaxFormRedactedSubmissionData' from JSON`,
  );
}
