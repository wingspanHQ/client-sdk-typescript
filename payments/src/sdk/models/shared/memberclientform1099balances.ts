...
export type MemberClientForm1099BalancesType = ClosedEnum<typeof MemberClientForm1099BalancesType>;
...
/** @internal */
export const MemberClientForm1099BalancesDeliveryMethod$inboundSchema: z.ZodNativeEnum<
    typeof MemberClientForm1099BalancesDeliveryMethod
> = z.nativeEnum(MemberClientForm1099BalancesDeliveryMethod);

/** @internal */
export const MemberClientForm1099BalancesDeliveryMethod$outboundSchema: z.ZodNativeEnum<
    typeof MemberClientForm1099BalancesDeliveryMethod
...
export namespace MemberClientForm1099BalancesDeliveryMethod$ {
    ...
    export const inboundSchema = MemberClientForm1099BalancesDeliveryMethod$inboundSchema;
    /** @deprecated use `MemberClientForm1099BalancesDeliveryMethod$outboundSchema` instead. */
    export const outboundSchema = MemberClientForm1099BalancesDeliveryMethod$outboundSchema;
}

/** @internal */
export const ExclusionReason$inboundSchema: z.ZodNativeEnum<typeof ExclusionReason> =
    z.nativeEnum(ExclusionReason);

/** @internal */
export const ExclusionReason$outboundSchema: z.ZodNativeEnum<typeof ExclusionReason> =
...
export namespace MemberClientForm1099BalancesStatus$ {
    ...
    export const outboundSchema = MemberClientForm1099BalancesStatus$outboundSchema;
}

/** @internal */
export const TaxForm$inboundSchema: z.ZodType<TaxForm, z.ZodTypeDef, unknown> = z.object({});

/** @internal */
export type TaxForm$Outbound = {};

/** @internal */
export const TaxForm$outboundSchema: z.ZodType<TaxForm$Outbound, z.ZodTypeDef, TaxForm> = z.object(
    {}
);
