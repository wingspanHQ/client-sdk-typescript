 ...
 */
export async function collaboratorManagementUpdateCollaboratorDeduction(
  client$: PaymentsCore,
...
> {
  ...
  const parsed$ = schemas$.safeParse(
    input$,
    (value$) =>
      operations.UpdateDeductionCollaboratorRequest$outboundSchema.parse(
        value$,
      ),
  ...
  const body$ = encodeJSON$("body", payload$.DeductionUpdateRequest, {
    explode: true,
  });
  ...
  const path$ = pathToFunc("/payments/collaborator-deduction/{id}")(
    pathParams$,
  );
