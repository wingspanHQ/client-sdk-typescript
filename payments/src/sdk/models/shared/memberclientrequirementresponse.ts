...
/** @internal */
export const MemberClientRequirementResponseRequirementType$inboundSchema: z.ZodNativeEnum<
    typeof MemberClientRequirementResponseRequirementType
> = z.nativeEnum(MemberClientRequirementResponseRequirementType);

/** @internal */
export const MemberClientRequirementResponseRequirementType$outboundSchema: z.ZodNativeEnum<
    typeof MemberClientRequirementResponseRequirementType
...
export namespace MemberClientRequirementResponseRequirementType$ {
    ...
    export const inboundSchema = MemberClientRequirementResponseRequirementType$inboundSchema;
    /** @deprecated use `MemberClientRequirementResponseRequirementType$outboundSchema` instead. */
    export const outboundSchema = MemberClientRequirementResponseRequirementType$outboundSchema;
}

/** @internal */
export const MemberClientRequirementResponseStatus$inboundSchema: z.ZodNativeEnum<
    typeof MemberClientRequirementResponseStatus
> = z.nativeEnum(MemberClientRequirementResponseStatus);

/** @internal */
export const MemberClientRequirementResponseStatus$outboundSchema: z.ZodNativeEnum<
    typeof MemberClientRequirementResponseStatus
...
export namespace MemberClientRequirementResponseStatus$ {
    ...
    export const inboundSchema = MemberClientRequirementResponseStatus$inboundSchema;
    /** @deprecated use `MemberClientRequirementResponseStatus$outboundSchema` instead. */
    export const outboundSchema = MemberClientRequirementResponseStatus$outboundSchema;
}
...
> = z.object({
    ...
    status: z.nullable(MemberClientRequirementResponseStatus$inboundSchema).optional(),
...
> = z.object({
    ...
    documentId: z.nullable(z.string()).optional(),
    eligibilityRequirementId: z.string(),
    requirementType: MemberClientRequirementResponseRequirementType$outboundSchema,
    status: z.nullable(MemberClientRequirementResponseStatus$outboundSchema).optional(),
    templateId: z.nullable(z.string()).optional(),
    validFor: z.nullable(z.number()).optional(),
});
