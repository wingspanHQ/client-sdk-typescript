...
/** @internal */
export const AutoPayStrategy$inboundSchema: z.ZodNativeEnum<
  typeof AutoPayStrategy
> = z.nativeEnum(AutoPayStrategy);

/** @internal */
export const AutoPayStrategy$outboundSchema: z.ZodNativeEnum<
  typeof AutoPayStrategy
...
/** @internal */
export const VerificationStratgy$inboundSchema: z.ZodNativeEnum<
  typeof VerificationStratgy
> = z.nativeEnum(VerificationStratgy);

/** @internal */
export const VerificationStratgy$outboundSchema: z.ZodNativeEnum<
  typeof VerificationStratgy
...
/** @internal */
export const ClientData$inboundSchema: z.ZodType<
  ClientData,
  z.ZodTypeDef,
  unknown
> = z.object({
...
/** @internal */
export const ClientData$outboundSchema: z.ZodType<
  ClientData$Outbound,
  z.ZodTypeDef,
  ClientData
> = z.object({
  ...
  externalId: z.nullable(z.string()).optional(),
  verificationStratgy: z.nullable(VerificationStratgy$outboundSchema)
    .optional(),
});
