...
export namespace ListInvoiceTemplatesResponse$ {
    export type Inbound = {
        ...
        StatusCode: number;
        RawResponse: Response;
        classes?: Array<shared.InvoiceTemplate$.Inbound> | undefined;
    };

    export const inboundSchema: z.ZodType<ListInvoiceTemplatesResponse, z.ZodTypeDef, Inbound> = z
        .object({
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, ListInvoiceTemplatesResponse> = z
        .object({
            contentType: z.string(),
            statusCode: z.number().int(),
