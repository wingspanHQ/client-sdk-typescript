...
async function run() {
  ...
  const result = await sdk.activityAndUsageTracking.deleteUsersActivityId({
    id: "<id>",
  });
...
async function run() {
  ...
  const result = await sdk.activityAndUsageTracking.getUsersActivity();
...
async function run() {
  ...
  const result = await sdk.activityAndUsageTracking.getUsersActivityId({
    id: "<id>",
  });
...
async function run() {
  ...
  const result = await sdk.activityAndUsageTracking.patchUsersActivityId({
...
async function run() {
  ...
  const result = await sdk.activityAndUsageTracking.postUsersActivity({
    userId: "<value>",
  });
