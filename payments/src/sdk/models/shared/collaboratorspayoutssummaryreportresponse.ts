...
/** @internal */
export const Labels$inboundSchema: z.ZodType<Labels, z.ZodTypeDef, unknown> = z.object({});

/** @internal */
export type Labels$Outbound = {};

/** @internal */
export const Labels$outboundSchema: z.ZodType<Labels$Outbound, z.ZodTypeDef, Labels> = z.object({});
...
/** @internal */
export const CollaboratorsPayoutsSummaryReportResponseStatus$inboundSchema: z.ZodNativeEnum<
    typeof CollaboratorsPayoutsSummaryReportResponseStatus
> = z.nativeEnum(CollaboratorsPayoutsSummaryReportResponseStatus);

/** @internal */
export const CollaboratorsPayoutsSummaryReportResponseStatus$outboundSchema: z.ZodNativeEnum<
    typeof CollaboratorsPayoutsSummaryReportResponseStatus
...
export namespace CollaboratorsPayoutsSummaryReportResponseStatus$ {
    ...
    export const inboundSchema = CollaboratorsPayoutsSummaryReportResponseStatus$inboundSchema;
    /** @deprecated use `CollaboratorsPayoutsSummaryReportResponseStatus$outboundSchema` instead. */
    export const outboundSchema = CollaboratorsPayoutsSummaryReportResponseStatus$outboundSchema;
}

/** @internal */
export const CollaboratorsPayoutsSummaryReportResponseTaxStatus$inboundSchema: z.ZodNativeEnum<
    typeof CollaboratorsPayoutsSummaryReportResponseTaxStatus
> = z.nativeEnum(CollaboratorsPayoutsSummaryReportResponseTaxStatus);

/** @internal */
export const CollaboratorsPayoutsSummaryReportResponseTaxStatus$outboundSchema: z.ZodNativeEnum<
    typeof CollaboratorsPayoutsSummaryReportResponseTaxStatus
...
export namespace CollaboratorsPayoutsSummaryReportResponseTaxStatus$ {
    ...
    export const inboundSchema = CollaboratorsPayoutsSummaryReportResponseTaxStatus$inboundSchema;
    /** @deprecated use `CollaboratorsPayoutsSummaryReportResponseTaxStatus$outboundSchema` instead. */
    export const outboundSchema = CollaboratorsPayoutsSummaryReportResponseTaxStatus$outboundSchema;
}
...
/** @internal */
export const CollaboratorsPayoutsSummaryReportResponse$outboundSchema: z.ZodType<
...
> = z.object({
    ...
    taxDocumentStared: z.nullable(z.boolean()).optional(),
    taxStatus: CollaboratorsPayoutsSummaryReportResponseTaxStatus$outboundSchema,
    updatedAt: z.string(),
});
...
export namespace CollaboratorsPayoutsSummaryReportResponse$ {
    ...
    export const inboundSchema = CollaboratorsPayoutsSummaryReportResponse$inboundSchema;
    /** @deprecated use `CollaboratorsPayoutsSummaryReportResponse$outboundSchema` instead. */
    export const outboundSchema = CollaboratorsPayoutsSummaryReportResponse$outboundSchema;
