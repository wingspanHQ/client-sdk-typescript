...
> = z.object({
    ...
    eligibilityRequirements: z.nullable(z.array(EligibilityRequirement$inboundSchema)).optional(),
    name: z.string(),
});
...
> = z.object({
    ...
    defaultGroup: z.boolean(),
    description: z.string(),
    eligibilityRequirements: z.nullable(z.array(EligibilityRequirement$outboundSchema)).optional(),
    name: z.string(),
});
