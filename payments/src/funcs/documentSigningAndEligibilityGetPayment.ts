 ...
 */
export async function documentSigningAndEligibilityGetPayment(
  client: PaymentsCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetPaymentEligibilityRequirementRequest$outboundSchema.parse(
        value,
      ),
  ...
  >(
    M.json(
      200,
      operations.GetPaymentEligibilityRequirementResponse$inboundSchema,
