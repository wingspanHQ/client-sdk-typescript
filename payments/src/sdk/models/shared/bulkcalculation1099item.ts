...
export type BulkCalculation1099ItemStatus = ClosedEnum<typeof BulkCalculation1099ItemStatus>;
...
/** @internal */
export const CalculationType$inboundSchema: z.ZodNativeEnum<typeof CalculationType> =
    z.nativeEnum(CalculationType);

/** @internal */
export const CalculationType$outboundSchema: z.ZodNativeEnum<typeof CalculationType> =
