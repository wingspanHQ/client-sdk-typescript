...
export namespace ExecuteClientInvoicePaymentRequest$ {
    ...
    export const outboundSchema = ExecuteClientInvoicePaymentRequest$outboundSchema;
...
export namespace ExecuteClientInvoicePaymentResponse$ {
    ...
    export const inboundSchema = ExecuteClientInvoicePaymentResponse$inboundSchema;
    /** @deprecated use `ExecuteClientInvoicePaymentResponse$outboundSchema` instead. */
    export const outboundSchema = ExecuteClientInvoicePaymentResponse$outboundSchema;
