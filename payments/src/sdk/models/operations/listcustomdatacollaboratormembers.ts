...
/** @internal */
export const ListCustomDataCollaboratorMembersResponse$outboundSchema: z.ZodType<
...
export namespace ListCustomDataCollaboratorMembersResponse$ {
    ...
    export const inboundSchema = ListCustomDataCollaboratorMembersResponse$inboundSchema;
    /** @deprecated use `ListCustomDataCollaboratorMembersResponse$outboundSchema` instead. */
    export const outboundSchema = ListCustomDataCollaboratorMembersResponse$outboundSchema;
