...
export namespace ListSpecificCollaboratorDetailsRequest$ {
    ...
    export const inboundSchema = ListSpecificCollaboratorDetailsRequest$inboundSchema;
    /** @deprecated use `ListSpecificCollaboratorDetailsRequest$outboundSchema` instead. */
    export const outboundSchema = ListSpecificCollaboratorDetailsRequest$outboundSchema;
...
export namespace ListSpecificCollaboratorDetailsResponse$ {
    ...
    export const inboundSchema = ListSpecificCollaboratorDetailsResponse$inboundSchema;
    /** @deprecated use `ListSpecificCollaboratorDetailsResponse$outboundSchema` instead. */
    export const outboundSchema = ListSpecificCollaboratorDetailsResponse$outboundSchema;
