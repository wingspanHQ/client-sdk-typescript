...
export namespace DeletePayableRequest$ {
    ...
    export const inboundSchema: z.ZodType<DeletePayableRequest, z.ZodTypeDef, Inbound> = z
        .object({
            id: z.string(),
        })
        .transform((v) => {
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, DeletePayableRequest> = z
        .object({
            id: z.string(),
        })
        .transform((v) => {
...
export namespace DeletePayableResponse$ {
    ...
    export const inboundSchema: z.ZodType<DeletePayableResponse, z.ZodTypeDef, Inbound> = z
        .object({
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, DeletePayableResponse> = z
        .object({
            contentType: z.string(),
