 ...
 */
export async function oneThousandAndNinetyNineOperationsCreate(
  client$: PaymentsCore,
...
> {
  ...
  const parsed$ = schemas$.safeParse(
    input$,
    (value$) =>
      operations.CreateRecipientSyncRequest$outboundSchema.parse(value$),
  ...
  const path$ = pathToFunc("/payments/tax-form/{taxFormId}/resync")(
    pathParams$,
  );
