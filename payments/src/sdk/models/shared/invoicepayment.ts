...
/** @internal */
export const InvoicePaymentStatus$inboundSchema: z.ZodNativeEnum<typeof InvoicePaymentStatus> =
    z.nativeEnum(InvoicePaymentStatus);

/** @internal */
export const InvoicePaymentStatus$outboundSchema: z.ZodNativeEnum<typeof InvoicePaymentStatus> =
...
/** @internal */
export const InvoicePayment$inboundSchema: z.ZodType<InvoicePayment, z.ZodTypeDef, unknown> =
    z.object({
        amount: z.number(),
        createdAt: z.string(),
...
> = z.object({
    ...
    paymentId: z.string(),
    sourceId: z.string(),
    sourceMetadata: Fa804b4efa97e487035ead1834462b69564f5e4ebbbd376106a1847d1c1aa4f4$outboundSchema,
