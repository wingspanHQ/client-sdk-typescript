...
export type UpdateEligibilityRequirementCollaboratorGroupRequest = {
  collaboratorGroupRequirementUpdate?:
    | shared.CollaboratorGroupRequirementUpdate
    | undefined;
  /**
...
/** @internal */
export const UpdateEligibilityRequirementCollaboratorGroupRequest$inboundSchema:
  z.ZodType<
    UpdateEligibilityRequirementCollaboratorGroupRequest,
    z.ZodTypeDef,
    unknown
  > = z.object({
    CollaboratorGroupRequirementUpdate: shared
      .CollaboratorGroupRequirementUpdate$inboundSchema.optional(),
...
/** @internal */
export const UpdateEligibilityRequirementCollaboratorGroupRequest$outboundSchema:
  z.ZodType<
  ...
  > = z.object({
    collaboratorGroupRequirementUpdate: shared
      .CollaboratorGroupRequirementUpdate$outboundSchema.optional(),
    eligibilityRequirementId: z.string(),
    id: z.string(),
  }).transform((v) => {
    return remap$(v, {
...
export namespace UpdateEligibilityRequirementCollaboratorGroupRequest$ {
  ...
  export const inboundSchema =
    UpdateEligibilityRequirementCollaboratorGroupRequest$inboundSchema;
...
/** @internal */
export const UpdateEligibilityRequirementCollaboratorGroupResponse$outboundSchema:
  z.ZodType<
