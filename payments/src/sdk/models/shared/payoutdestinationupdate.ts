...
/** @internal */
export const PayoutDestinationUpdateDestinationType$inboundSchema: z.ZodNativeEnum<
    typeof PayoutDestinationUpdateDestinationType
> = z.nativeEnum(PayoutDestinationUpdateDestinationType);

/** @internal */
export const PayoutDestinationUpdateDestinationType$outboundSchema: z.ZodNativeEnum<
    typeof PayoutDestinationUpdateDestinationType
...
export namespace PayoutDestinationUpdateDestinationType$ {
    ...
    export const inboundSchema = PayoutDestinationUpdateDestinationType$inboundSchema;
    /** @deprecated use `PayoutDestinationUpdateDestinationType$outboundSchema` instead. */
    export const outboundSchema = PayoutDestinationUpdateDestinationType$outboundSchema;
}
...
/** @internal */
export const PayoutDestinationUpdatePayoutMethod$outboundSchema: z.ZodNativeEnum<
    typeof PayoutDestinationUpdatePayoutMethod
...
export namespace PayoutDestinationUpdatePayoutMethod$ {
    ...
    export const inboundSchema = PayoutDestinationUpdatePayoutMethod$inboundSchema;
    /** @deprecated use `PayoutDestinationUpdatePayoutMethod$outboundSchema` instead. */
    export const outboundSchema = PayoutDestinationUpdatePayoutMethod$outboundSchema;
}
...
> = z.object({
    ...
    destinationType: z.nullable(PayoutDestinationUpdateDestinationType$inboundSchema).optional(),
    payoutMethod: z.nullable(PayoutDestinationUpdatePayoutMethod$inboundSchema).optional(),
...
> = z.object({
    destinationId: z.nullable(z.string()).optional(),
    destinationType: z.nullable(PayoutDestinationUpdateDestinationType$outboundSchema).optional(),
    payoutMethod: z.nullable(PayoutDestinationUpdatePayoutMethod$outboundSchema).optional(),
    percentage: z.nullable(z.number()).optional(),
});
