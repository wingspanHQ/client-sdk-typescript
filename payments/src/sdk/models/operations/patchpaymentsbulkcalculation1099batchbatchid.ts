...
export class PatchPaymentsBulkCalculation1099BatchBatchIdRequest extends SpeakeasyBase {
...
export class PatchPaymentsBulkCalculation1099BatchBatchIdResponse extends SpeakeasyBase {
    /**
