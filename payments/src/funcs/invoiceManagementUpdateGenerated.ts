 ...
 */
export async function invoiceManagementUpdateGenerated(
  client: PaymentsCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.UpdateGeneratedInvoiceRequest$outboundSchema.parse(value),
  ...
  const body = encodeJSON("body", payload.ClientInvoiceUpdateRequest, {
    explode: true,
  });
