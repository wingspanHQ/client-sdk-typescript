...
export type TaxFormSubmissionDeliveryMethod = ClosedEnum<typeof TaxFormSubmissionDeliveryMethod>;
...
export type TaxFormSubmissionStatus = ClosedEnum<typeof TaxFormSubmissionStatus>;
...
/** @internal */
export const CorrectionType$inboundSchema: z.ZodNativeEnum<typeof CorrectionType> =
    z.nativeEnum(CorrectionType);

/** @internal */
export const CorrectionType$outboundSchema: z.ZodNativeEnum<typeof CorrectionType> =
...
/** @internal */
export const TaxFormSubmission$inboundSchema: z.ZodType<TaxFormSubmission, z.ZodTypeDef, unknown> =
    z.object({
