...
export namespace GenerateTestInvoiceResponse$ {
    ...
    export const inboundSchema: z.ZodType<GenerateTestInvoiceResponse, z.ZodTypeDef, Inbound> = z
        .object({
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, GenerateTestInvoiceResponse> = z
        .object({
