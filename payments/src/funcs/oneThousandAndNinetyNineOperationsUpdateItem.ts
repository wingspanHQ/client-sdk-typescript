...
> {
    ...
    const parsed$ = schemas$.safeParse(
        input$,
        (value$) => operations.UpdateCalculation1099BatchItemRequest$outboundSchema.parse(value$),
    ...
    const body$ = encodeJSON$("body", payload$.BulkCalculation1099ItemUpdate, { explode: true });
    ...
    const path$ = pathToFunc("/payments/bulk/calculation1099/batch/{batchId}/item/{batchItemId}")(
        pathParams$
    );
