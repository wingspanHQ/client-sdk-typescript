...
/** @internal */
export const ExecuteApprovedPayrollTransactionResponse$outboundSchema: z.ZodType<
...
export namespace ExecuteApprovedPayrollTransactionResponse$ {
    ...
    export const inboundSchema = ExecuteApprovedPayrollTransactionResponse$inboundSchema;
    /** @deprecated use `ExecuteApprovedPayrollTransactionResponse$outboundSchema` instead. */
    export const outboundSchema = ExecuteApprovedPayrollTransactionResponse$outboundSchema;
