...
export type InvoiceAcceptedPaymentMethods = ClosedEnum<typeof InvoiceAcceptedPaymentMethods>;
...
/** @internal */
export const InvoiceCurrency$inboundSchema: z.ZodNativeEnum<typeof InvoiceCurrency> =
    z.nativeEnum(InvoiceCurrency);

/** @internal */
export const InvoiceCurrency$outboundSchema: z.ZodNativeEnum<typeof InvoiceCurrency> =
...
/** @internal */
export const InvoiceSchemasStatus$inboundSchema: z.ZodNativeEnum<typeof InvoiceSchemasStatus> =
    z.nativeEnum(InvoiceSchemasStatus);

/** @internal */
export const InvoiceSchemasStatus$outboundSchema: z.ZodNativeEnum<typeof InvoiceSchemasStatus> =
...
export const Invoice$inboundSchema: z.ZodType<Invoice, z.ZodTypeDef, unknown> = z.object({
    acceptedPaymentMethods: z
        .nullable(z.array(InvoiceAcceptedPaymentMethods$inboundSchema))
        .optional(),
    ...
    payoutDestinations: z.nullable(z.array(InvoicePayoutDestination$inboundSchema)).optional(),
    processingFees: z.nullable(ProcessingFees$inboundSchema).optional(),
    refundDestinations: z.nullable(z.array(InvoiceRefundDestination$inboundSchema)).optional(),
...
export const Invoice$outboundSchema: z.ZodType<Invoice$Outbound, z.ZodTypeDef, Invoice> = z.object({
    acceptedPaymentMethods: z
        .nullable(z.array(InvoiceAcceptedPaymentMethods$outboundSchema))
        .optional(),
    accountId: z.nullable(z.string()).optional(),
    amount: z.number(),
    ...
    payoutDestinations: z.nullable(z.array(InvoicePayoutDestination$outboundSchema)).optional(),
    processingFees: z.nullable(ProcessingFees$outboundSchema).optional(),
    refundDestinations: z.nullable(z.array(InvoiceRefundDestination$outboundSchema)).optional(),
    sourceId: z.nullable(z.string()).optional(),
