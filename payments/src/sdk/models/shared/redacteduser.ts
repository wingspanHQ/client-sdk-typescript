...
/** @internal */
export const RedactedUserStatus$inboundSchema: z.ZodNativeEnum<typeof RedactedUserStatus> =
    z.nativeEnum(RedactedUserStatus);

/** @internal */
export const RedactedUserStatus$outboundSchema: z.ZodNativeEnum<typeof RedactedUserStatus> =
...
/** @internal */
export const RedactedUser$inboundSchema: z.ZodType<RedactedUser, z.ZodTypeDef, unknown> = z.object({
    ...
    phone: z
        ...
        .optional(),
    profile: z
        .nullable(F6f2bd1a2fc7bad4e0d8f22345fc5f6699d096b7797b93575869c544a4fc5cef$inboundSchema)
        .optional(),
    settings: z
        .nullable(Ninee97e63e736df301658ebeeab7f4fe84f3aeaa73800d3e4863801a3eb026df4b$inboundSchema)
        .optional(),
...
> = z.object({
    ...
    phone: z
        ...
        .optional(),
    profile: z
        .nullable(F6f2bd1a2fc7bad4e0d8f22345fc5f6699d096b7797b93575869c544a4fc5cef$outboundSchema)
        .optional(),
    settings: z
        .nullable(
            Ninee97e63e736df301658ebeeab7f4fe84f3aeaa73800d3e4863801a3eb026df4b$outboundSchema
