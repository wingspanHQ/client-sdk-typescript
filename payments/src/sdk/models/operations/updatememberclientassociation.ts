...
export namespace UpdateMemberClientAssociationRequest$ {
    ...
    export const inboundSchema = UpdateMemberClientAssociationRequest$inboundSchema;
    /** @deprecated use `UpdateMemberClientAssociationRequest$outboundSchema` instead. */
    export const outboundSchema = UpdateMemberClientAssociationRequest$outboundSchema;
...
export namespace UpdateMemberClientAssociationResponse$ {
    ...
    export const inboundSchema = UpdateMemberClientAssociationResponse$inboundSchema;
    /** @deprecated use `UpdateMemberClientAssociationResponse$outboundSchema` instead. */
    export const outboundSchema = UpdateMemberClientAssociationResponse$outboundSchema;
