...
/** @internal */
export const UpdateCollaboratorGroupConfigurationRequest$inboundSchema: z.ZodType<
...
export type UpdateCollaboratorGroupConfigurationRequest$Outbound = {
    CollaboratorGroupUpdateRequest?: shared.CollaboratorGroupUpdateRequest$Outbound | undefined;
    id: string;
};

/** @internal */
export const UpdateCollaboratorGroupConfigurationRequest$outboundSchema: z.ZodType<
...
export namespace UpdateCollaboratorGroupConfigurationRequest$ {
    ...
    export const inboundSchema = UpdateCollaboratorGroupConfigurationRequest$inboundSchema;
    /** @deprecated use `UpdateCollaboratorGroupConfigurationRequest$outboundSchema` instead. */
    export const outboundSchema = UpdateCollaboratorGroupConfigurationRequest$outboundSchema;
...
/** @internal */
export const UpdateCollaboratorGroupConfigurationResponse$inboundSchema: z.ZodType<
...
/** @internal */
export const UpdateCollaboratorGroupConfigurationResponse$outboundSchema: z.ZodType<
...
export namespace UpdateCollaboratorGroupConfigurationResponse$ {
    ...
    export const inboundSchema = UpdateCollaboratorGroupConfigurationResponse$inboundSchema;
    /** @deprecated use `UpdateCollaboratorGroupConfigurationResponse$outboundSchema` instead. */
    export const outboundSchema = UpdateCollaboratorGroupConfigurationResponse$outboundSchema;
