...
export namespace BulkPayableBatchProcessingStrategy$ {
    ...
    export const outboundSchema = BulkPayableBatchProcessingStrategy$outboundSchema;
}

/** @internal */
export const BulkPayableBatchStatus$inboundSchema: z.ZodNativeEnum<typeof BulkPayableBatchStatus> =
    z.nativeEnum(BulkPayableBatchStatus);

/** @internal */
export const BulkPayableBatchStatus$outboundSchema: z.ZodNativeEnum<typeof BulkPayableBatchStatus> =
...
/** @internal */
export const BulkPayableBatch$inboundSchema: z.ZodType<BulkPayableBatch, z.ZodTypeDef, unknown> =
    z.object({
