...
/** @internal */
export const ListPaymentEligibilityRequirementsResponse$inboundSchema: z.ZodType<
...
/** @internal */
export const ListPaymentEligibilityRequirementsResponse$outboundSchema: z.ZodType<
...
export namespace ListPaymentEligibilityRequirementsResponse$ {
    ...
    export const inboundSchema = ListPaymentEligibilityRequirementsResponse$inboundSchema;
    /** @deprecated use `ListPaymentEligibilityRequirementsResponse$outboundSchema` instead. */
    export const outboundSchema = ListPaymentEligibilityRequirementsResponse$outboundSchema;
