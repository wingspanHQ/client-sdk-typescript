...
/** @internal */
export const FundingSourceCurrency$inboundSchema: z.ZodNativeEnum<typeof FundingSourceCurrency> =
    z.nativeEnum(FundingSourceCurrency);

/** @internal */
export const FundingSourceCurrency$outboundSchema: z.ZodNativeEnum<typeof FundingSourceCurrency> =
...
/** @internal */
export const FundingSourceType$inboundSchema: z.ZodNativeEnum<typeof FundingSourceType> =
    z.nativeEnum(FundingSourceType);

/** @internal */
export const FundingSourceType$outboundSchema: z.ZodNativeEnum<typeof FundingSourceType> =
...
/** @internal */
export const FundingSource$inboundSchema: z.ZodType<FundingSource, z.ZodTypeDef, unknown> =
    z.object({
