 ...
 */
export async function wingspanWalletDelete(
  client$: PaymentsCore,
...
> {
  ...
  const parsed$ = schemas$.safeParse(
    input$,
    (value$) =>
      operations.DeleteStoredWingspanWalletCardRequest$outboundSchema.parse(
        value$,
      ),
  ...
  >(
    m$.json(
      200,
      operations.DeleteStoredWingspanWalletCardResponse$inboundSchema,
      { key: "Card" },
    ),
