...
export class PostPaymentsPayoutSettingsMemberIdDebitCardRequest extends SpeakeasyBase {
...
export class PostPaymentsPayoutSettingsMemberIdDebitCardResponse extends SpeakeasyBase {
    /**
     * A payout debit card
     */
    @SpeakeasyMetadata()
