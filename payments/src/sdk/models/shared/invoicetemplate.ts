...
/** @internal */
export const InvoiceTemplateStatus$inboundSchema: z.ZodNativeEnum<typeof InvoiceTemplateStatus> =
    z.nativeEnum(InvoiceTemplateStatus);

/** @internal */
export const InvoiceTemplateStatus$outboundSchema: z.ZodNativeEnum<typeof InvoiceTemplateStatus> =
...
/** @internal */
export const InvoiceTemplate$inboundSchema: z.ZodType<InvoiceTemplate, z.ZodTypeDef, unknown> =
    z.object({
