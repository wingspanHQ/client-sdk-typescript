...
export namespace CreateClientInvoiceTemplateResponse$ {
    ...
    export const inboundSchema = CreateClientInvoiceTemplateResponse$inboundSchema;
    /** @deprecated use `CreateClientInvoiceTemplateResponse$outboundSchema` instead. */
    export const outboundSchema = CreateClientInvoiceTemplateResponse$outboundSchema;
