...
/** @internal */
export const PayoutDestinationResponseDestinationType$inboundSchema: z.ZodNativeEnum<
    typeof PayoutDestinationResponseDestinationType
> = z.nativeEnum(PayoutDestinationResponseDestinationType);

/** @internal */
export const PayoutDestinationResponseDestinationType$outboundSchema: z.ZodNativeEnum<
    typeof PayoutDestinationResponseDestinationType
...
export namespace PayoutDestinationResponseDestinationType$ {
    ...
    export const inboundSchema = PayoutDestinationResponseDestinationType$inboundSchema;
    /** @deprecated use `PayoutDestinationResponseDestinationType$outboundSchema` instead. */
    export const outboundSchema = PayoutDestinationResponseDestinationType$outboundSchema;
}

/** @internal */
export const PayoutDestinationResponsePayoutMethod$inboundSchema: z.ZodNativeEnum<
    typeof PayoutDestinationResponsePayoutMethod
> = z.nativeEnum(PayoutDestinationResponsePayoutMethod);

/** @internal */
export const PayoutDestinationResponsePayoutMethod$outboundSchema: z.ZodNativeEnum<
    typeof PayoutDestinationResponsePayoutMethod
...
export namespace PayoutDestinationResponsePayoutMethod$ {
    ...
    export const inboundSchema = PayoutDestinationResponsePayoutMethod$inboundSchema;
    /** @deprecated use `PayoutDestinationResponsePayoutMethod$outboundSchema` instead. */
    export const outboundSchema = PayoutDestinationResponsePayoutMethod$outboundSchema;
}
