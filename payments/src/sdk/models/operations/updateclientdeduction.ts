...
export namespace UpdateClientDeductionRequest$ {
    ...
    export const inboundSchema: z.ZodType<UpdateClientDeductionRequest, z.ZodTypeDef, Inbound> = z
        .object({
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, UpdateClientDeductionRequest> = z
        .object({
...
export namespace UpdateClientDeductionResponse$ {
    ...
    export const inboundSchema: z.ZodType<UpdateClientDeductionResponse, z.ZodTypeDef, Inbound> = z
        .object({
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, UpdateClientDeductionResponse> =
        z
            .object({
                contentType: z.string(),
