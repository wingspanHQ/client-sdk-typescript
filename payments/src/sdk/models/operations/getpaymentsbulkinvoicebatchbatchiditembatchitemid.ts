...
export class GetPaymentsBulkInvoiceBatchBatchIdItemBatchItemIdRequest extends SpeakeasyBase {
    /**
...
export class GetPaymentsBulkInvoiceBatchBatchIdItemBatchItemIdResponse extends SpeakeasyBase {
    /**
