 ...
 */
export async function documentSigningAndEligibilityUpdate(
  client$: PaymentsCore,
...
> {
  ...
  const body$ = encodeJSON$(
    "body",
    payload$.EligibilityRequirementUpdateRequest,
    { explode: true },
  );
  ...
  >(
    m$.json(
      200,
      operations.UpdateEligibilityRequirementResponse$inboundSchema,
      { key: "classes" },
    ),
