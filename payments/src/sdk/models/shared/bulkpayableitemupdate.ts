...
export namespace BulkPayableItemUpdatePayableStatus$ {
    ...
    export const outboundSchema = BulkPayableItemUpdatePayableStatus$outboundSchema;
}

/** @internal */
export const BulkPayableItemUpdateWorkflowSubStatus$inboundSchema: z.ZodNativeEnum<
    typeof BulkPayableItemUpdateWorkflowSubStatus
> = z.nativeEnum(BulkPayableItemUpdateWorkflowSubStatus);

/** @internal */
export const BulkPayableItemUpdateWorkflowSubStatus$outboundSchema: z.ZodNativeEnum<
    typeof BulkPayableItemUpdateWorkflowSubStatus
...
export namespace BulkPayableItemUpdateWorkflowSubStatus$ {
    ...
    export const inboundSchema = BulkPayableItemUpdateWorkflowSubStatus$inboundSchema;
    /** @deprecated use `BulkPayableItemUpdateWorkflowSubStatus$outboundSchema` instead. */
    export const outboundSchema = BulkPayableItemUpdateWorkflowSubStatus$outboundSchema;
}
...
> = z.object({
    ...
    payableStatus: z.nullable(BulkPayableItemUpdatePayableStatus$inboundSchema).optional(),
    reimbursableExpense: z.nullable(z.boolean()).optional(),
    workflowSubStatus: z.nullable(BulkPayableItemUpdateWorkflowSubStatus$inboundSchema).optional(),
});
...
> = z.object({
    ...
    paidDate: z.nullable(z.string()).optional(),
    payableNotes: z.nullable(z.string()).optional(),
    payableStatus: z.nullable(BulkPayableItemUpdatePayableStatus$outboundSchema).optional(),
    reimbursableExpense: z.nullable(z.boolean()).optional(),
    workflowSubStatus: z.nullable(BulkPayableItemUpdateWorkflowSubStatus$outboundSchema).optional(),
});
