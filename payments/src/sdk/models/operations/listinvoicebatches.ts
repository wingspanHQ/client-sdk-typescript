...
export namespace ListInvoiceBatchesResponse$ {
    export type Inbound = {
        ...
        StatusCode: number;
        RawResponse: Response;
        classes?: Array<shared.BulkInvoiceBatch$.Inbound> | undefined;
    };

    export const inboundSchema: z.ZodType<ListInvoiceBatchesResponse, z.ZodTypeDef, Inbound> = z
        .object({
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, ListInvoiceBatchesResponse> = z
        .object({
            contentType: z.string(),
            statusCode: z.number().int(),
