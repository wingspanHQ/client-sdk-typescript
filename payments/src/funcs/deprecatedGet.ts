...
> {
    ...
    const parsed$ = schemas$.safeParse(
        input$,
        (value$) => operations.GetCustomDataCollaboratorMemberRequest$outboundSchema.parse(value$),
    ...
    const path$ = pathToFunc("/payments/collaborator-settings/additional-data/{id}")(pathParams$);
