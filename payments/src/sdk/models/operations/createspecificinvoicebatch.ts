...
export namespace CreateSpecificInvoiceBatchRequest$ {
    ...
    export const outboundSchema = CreateSpecificInvoiceBatchRequest$outboundSchema;
...
export namespace CreateSpecificInvoiceBatchResponse$ {
    ...
    export const outboundSchema = CreateSpecificInvoiceBatchResponse$outboundSchema;
