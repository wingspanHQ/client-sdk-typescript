...
export namespace ListClientDeductionsResponse$ {
    export type Inbound = {
        ...
        StatusCode: number;
        RawResponse: Response;
        classes?: Array<shared.DeductionResponse$.Inbound> | undefined;
    };

    export const inboundSchema: z.ZodType<ListClientDeductionsResponse, z.ZodTypeDef, Inbound> = z
        .object({
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, ListClientDeductionsResponse> = z
        .object({
            contentType: z.string(),
            statusCode: z.number().int(),
